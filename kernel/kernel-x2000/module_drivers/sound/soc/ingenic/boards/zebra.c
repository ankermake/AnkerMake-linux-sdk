...
static struct snd_soc_dai_link x2000_dais[] = {
	...
	[10] = {
		...
		.stream_name = "BAIC0",
		.cpu_dai_name = "BAIC0",
		.codec_dai_name = "icodec",
		.codec_name = "10020000.icodec",
		.ops = &baic_ops,
	...
	[12] = {
		...
		.stream_name = "BAIC2",
		.cpu_dai_name = "BAIC2",
		.codec_dai_name = "ak5558.6-0013",
		.codec_name = "ak5558.6-0013",
		.ops = &baic_ops,
		.be_hw_params_fixup = NULL,
		.dpcm_capture = 1,
		.no_pcm = 1,
	...
	[13] = {
		...
		.stream_name = "BAIC3",
		.cpu_dai_name = "BAIC3",
		.codec_dai_name = "ak4458.2-0010",
		.codec_name = "ak4458.2-0010",
		.ops = &baic_ops,
		.be_hw_params_fixup = NULL,
		.dpcm_playback = 1,
		.no_pcm = 1,
