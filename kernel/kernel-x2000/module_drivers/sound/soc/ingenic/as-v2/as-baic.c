...
#define ingenic_baic_dai_suspend	NULL
#define ingenic_baic_dai_resume		NULL
...
static int ingenic_baic_platform_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < num_dais; i++) {
		...
		baic->dai_driver[i].suspend = ingenic_baic_dai_suspend;
		baic->dai_driver[i].resume = ingenic_baic_dai_resume;
