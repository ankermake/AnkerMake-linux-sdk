				...
				struct snd_soc_dai *dai)
{
	...
	u16 dac1_ctrl2 = wm8594_read(codec, WM8594_DAC1_CTRL2) & ~0x3f;
	u16 dac2_ctrl1 = wm8594_read(codec, WM8594_DAC2_CTRL1) & ~0xc;
	u16 dac2_ctrl2 = wm8594_read(codec, WM8594_DAC2_CTRL2) & ~0x3f;

	u16 adc_ctrl1 = wm8594_read(codec, WM8594_ADC_CTRL1) & ~0xc;
	u16 adc_ctrl2 = wm8594_read(codec, WM8594_ADC_CTRL2) & ~0x3f;
	...
	if(substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
		...
		wm8594_write(codec, WM8594_DAC1_CTRL2, dac1_ctrl2);
		wm8594_write(codec, WM8594_DAC2_CTRL1, dac2_ctrl1);
		wm8594_write(codec, WM8594_DAC2_CTRL2, dac2_ctrl2);
	} else {
		wm8594_write(codec, WM8594_ADC_CTRL1, adc_ctrl1);
		wm8594_write(codec, WM8594_ADC_CTRL2, adc_ctrl2);
	}
...
static int wm8594_probe(struct snd_soc_codec *codec)
{
	...
	dev_dbg(codec->dev, "WM8594 ID: 0x%08x\n",
			wm8594_read(codec, WM8594_RESET));
