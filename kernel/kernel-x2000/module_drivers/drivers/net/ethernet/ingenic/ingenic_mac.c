...
static int mii_probe(struct net_device *dev)
{
	...
	phydev->supported |= (SUPPORTED_Pause | SUPPORTED_Asym_Pause | SUPPORTED_1000baseT_Half | SUPPORTED_Autoneg);
...
struct ingenic_gmac_priv x2000_v12_priv = {
	.support_multi_if = 1,
...
static const struct of_device_id ingenic_mac_dt_match[] = {
	...
	{ .compatible = "ingenic,x2000-v12-mac", .data = &x2000_v12_priv },
