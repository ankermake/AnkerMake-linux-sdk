...
CLOCKSOURCE_OF_DECLARE(x1021_ost_init, "ingenic,x1021-ost", ingenic_ost_init);
CLOCKSOURCE_OF_DECLARE(x1520_ost_init, "ingenic,x1520-ost", ingenic_ost_init);
CLOCKSOURCE_OF_DECLARE(x1600_ost_init, "ingenic,x1600-ost", ingenic_ost_init);
CLOCKSOURCE_OF_DECLARE(x1630_ost_init, "ingenic,x1630-ost", ingenic_ost_init);
