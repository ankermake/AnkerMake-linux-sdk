...
static struct regval_list sc230ai_init_regs_1920_1080_30fps_MIPI[] = {
	...
	{0x36e9,0x20},
	{0x37f9,0x27},
//	{0x4501,0xbc}, /*test pattern*/
//	{0x3902,0x85}, /*test pattern*/
...
int sc230ai_g_parm(struct v4l2_subdev *sd, struct v4l2_streamparm *param)
{
	struct sc230ai_info *info = to_state(sd);
...
int sc230ai_riscv_notifier(struct notifier_block *nb, unsigned long action, void *data)
{
	struct sc230ai_info *info = container_of(nb, struct sc230ai_info, nb);
...
#ifdef CONFIG_X2500_RISCV
	info->nb.notifier_call = sc230ai_riscv_notifier;
