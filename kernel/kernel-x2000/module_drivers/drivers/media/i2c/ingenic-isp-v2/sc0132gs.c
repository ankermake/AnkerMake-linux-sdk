...
static struct regval_list sc0132gs_init_regs_1080_1280_40fps_mipi[] = {
	//[ParaList]
#if 1
	//sc132gs_setting_1080x1280
	{0x0103,0x01},
...
static struct sc0132gs_win_size sc0132gs_win_sizes[] = {
	{
		...
		.sensor_info.mipi_cfg.data_type_value	= RAW8,
		...
		.sensor_info.mipi_cfg.sensor_csi_fmt		= TX_SENSOR_RAW8,
		.mbus_code	= MEDIA_BUS_FMT_SBGGR8_1X8,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= sc0132gs_init_regs_1080_1280_40fps_mipi,
	},
	{
		.width				= 1080,
		.height				= 1280,
		.sensor_info.fps				= 40 << 16 | 1,
		.sensor_info.total_width			= 1928,
		.sensor_info.total_height			= 1152,
		.sensor_info.wdr_en				= 0,
		.sensor_info.mipi_cfg.clk			= 600,
