...
static struct ingenic_fixed_rate_clock x2000_fixed_rate_ext_clks[] __initdata = {
	...
	FRATE(CLK_EXT_DIV_512, "ext_div_512", NULL, CLK_IS_ROOT, 46875),
};
...
//	GATE(CLK_GATE_IPU,	"gate_ipu",		"div_ipu",	CPM_CLKGR,  30, 0,			 CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_MIPI_CSI, "gate_csi",		"div_ahb0",	CPM_CLKGR1, 28, CLK_IGNORE_UNUSED, 			CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_ISP1,	"gate_isp1",		"div_apb",	CPM_CLKGR1, 3,  CLK_IGNORE_UNUSED, 			CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_ISP0,	"gate_isp0",		"div_apb",	CPM_CLKGR1, 2,  CLK_IGNORE_UNUSED, 			CLK_GATE_SET_TO_DISABLE),
...
static struct ingenic_gate_power x2000_gate_power[] __initdata = {
	...
	POWER(POWER_ISP0,	"power_isp0",		"gate_isp0",	CPM_LCR,  31, 27, 0,	CLK_GATE_SET_TO_DISABLE, POWER_GATE_WAIT),
	POWER(POWER_ISP1,	"power_isp1",		"gate_isp1",	CPM_LCR,  30, 26, 0,	CLK_GATE_SET_TO_DISABLE, POWER_GATE_WAIT),
	POWER(POWER_FELIX,	"power_felix",		"gate_felix",	CPM_LCR,  29, 25, 0,	CLK_GATE_SET_TO_DISABLE, POWER_GATE_WAIT),
	POWER(POWER_HELIX,	"power_helix",		"gate_helix",	CPM_LCR,  28, 24, 0,	CLK_GATE_SET_TO_DISABLE, POWER_GATE_WAIT),
...
CLK_OF_DECLARE(x2100_clk, "ingenic,x2100-clocks", x2000_clk_init);
