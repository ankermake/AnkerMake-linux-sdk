...
#define SOC_NNA_VERSION "H20211130"
...
int soc_nna_version(long usr_arg)
{
	long ret = 0;
	uint32_t nna_version = 0X00000001;

	if (copy_to_user((void __user *)usr_arg, &nna_version, sizeof(uint32_t))) {
