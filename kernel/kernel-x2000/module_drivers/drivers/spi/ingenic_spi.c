...
static const struct of_device_id ingenic_spi_match[] = {
	{ .compatible = "ingenic,x1000-spi", .data = (void *)&cgu_priv },
	{ .compatible = "ingenic,x1021-spi", .data = (void *)&cgu_priv },
	{ .compatible = "ingenic,x1520-spi", .data = (void *)&cgu_priv },
	{ .compatible = "ingenic,x1630-spi", .data = (void *)&cgu_priv },
	{ .compatible = "ingenic,x1800-spi", .data = (void *)&cgu_priv },
	...
	{ .compatible = "ingenic,x2000-v12-spi", .data = (void *)&default_priv },
	{}
};
...
static int ingenic_spi_probe(struct platform_device *pdev)
{
	...
	ingspi->g_ingenic_intr = devm_kzalloc(&pdev->dev, sizeof(struct ingenic_intr_cnt),GFP_KERNEL);
