...
#include <dt-bindings/clock/ingenic-x1021.h>
...
#define X1021_CPCCR_HWDESC(_id) &cpccr_hwdesc[INDEX_CPCCR_HWDESC((_id))]
...
static const int cgu_sel_grp0[] = { CLK_MUX_SCLKA, CLK_PLL_MPLL, CLK_PLL_VPLL, CLK_PLL_VPLL};
...
static struct ingenic_cgu_hwdesc cgu_hwdesc[] = {
	...
	[INDEX_CGU_HWDESC(CLK_CGU_TIZIANO)]	= CGU_DESC(CPM_TIZIANOCDR, 30, 0x3, 29, 27, 26, 0, 0xf, 1),	/*tiziano*/
...
#define X1021_CGU_HWDESC(_id) &cgu_hwdesc[INDEX_CGU_HWDESC((_id))]
...
static struct ingenic_gate_hwdesc gate_hwdesc[] = {
	...
	[INDEX_GATE_HWDESC(CLK_GATE_SC_HASH)	] =	GATE_DESC(CPM_CLKGR, 18),
	...
	[INDEX_GATE_HWDESC(CLK_GATE_TIZIANO)	] =	GATE_DESC(CPM_CLKGR, 23),
	[INDEX_GATE_HWDESC(CLK_GATE_LCD)	] =	GATE_DESC(CPM_CLKGR, 24),
	[INDEX_GATE_HWDESC(CLK_GATE_RISCV)	] =	GATE_DESC(CPM_CLKGR, 26),
...
#define X1021_CLK_MUX(_id, _pids, _ops, _flags, _phwdesc)	\
		CLK_INIT_DATA_LOCKED(_id, _ops, _pids, ARRAY_SIZE(_pids), _flags, _phwdesc)

/*Note: parent num == 1, _pid is parent clock id*/
#define X1021_CLK(_id, _pid, _ops, _flags, _phwdesc)	\
	CLK_INIT_DATA_LOCKED(_id, _ops, _pid, 1, _flags, _phwdesc)

static const struct ingenic_clk_init __initdata x1021_clk_init_data[] = {
	/*pll*/
	X1021_CLK(CLK_PLL_APLL, CLK_EXT, &ingenic_pll_v2_ro_ops, CLK_IGNORE_UNUSED, &apll_hwdesc),
	X1021_CLK(CLK_PLL_MPLL, CLK_EXT, &ingenic_pll_v2_ro_ops, CLK_IGNORE_UNUSED, &mpll_hwdesc),
	X1021_CLK(CLK_PLL_VPLL, CLK_EXT, &ingenic_pll_v2_ro_ops, CLK_IGNORE_UNUSED, &vpll_hwdesc),

	/*cpccr*/
	X1021_CLK_MUX(CLK_MUX_SCLKA, sclk_a_p, &ingenic_cpccr_mux_ro_ops, 0, X1021_CPCCR_HWDESC(CLK_MUX_SCLKA)),
	X1021_CLK_MUX(CLK_MUX_CPLL, cpccr_p, &ingenic_cpccr_mux_ro_ops, 0, X1021_CPCCR_HWDESC(CLK_MUX_CPLL)),
	X1021_CLK_MUX(CLK_MUX_H0PLL, cpccr_p, &ingenic_cpccr_mux_ro_ops, 0, X1021_CPCCR_HWDESC(CLK_MUX_H0PLL)),
	X1021_CLK_MUX(CLK_MUX_H2PLL, cpccr_p, &ingenic_cpccr_mux_ro_ops, 0, X1021_CPCCR_HWDESC(CLK_MUX_H2PLL)),
	X1021_CLK(CLK_RATE_PCLK, CLK_MUX_H2PLL, &ingenic_cpccr_rate_ro_ops,0, X1021_CPCCR_HWDESC(CLK_RATE_PCLK)),
	X1021_CLK(CLK_RATE_H2CLK, CLK_MUX_H2PLL, &ingenic_cpccr_rate_ro_ops,0, X1021_CPCCR_HWDESC(CLK_RATE_H2CLK)),
	X1021_CLK(CLK_RATE_H0CLK, CLK_MUX_H0PLL, &ingenic_cpccr_rate_ro_ops,0, X1021_CPCCR_HWDESC(CLK_RATE_H0CLK)),
	X1021_CLK(CLK_RATE_CPUCLK, CLK_MUX_CPLL, &ingenic_cpccr_rate_ro_ops,0, X1021_CPCCR_HWDESC(CLK_RATE_CPUCLK)),
	X1021_CLK(CLK_RATE_L2CCLK, CLK_MUX_CPLL, &ingenic_cpccr_rate_ro_ops,0, X1021_CPCCR_HWDESC(CLK_RATE_L2CCLK)),

	/*cgu*/
	X1021_CLK_MUX(CLK_CGU_DDR, cgu_ddr, &ingenic_cgu_ops, CLK_IGNORE_UNUSED, X1021_CGU_HWDESC(CLK_CGU_DDR)),
	X1021_CLK_MUX(CLK_CGU_MAC, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1021_CGU_HWDESC(CLK_CGU_MAC)),
	X1021_CLK_MUX(CLK_CGU_TIZIANO, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1021_CGU_HWDESC(CLK_CGU_TIZIANO)),
	X1021_CLK_MUX(CLK_CGU_MSCMUX, cgu_sel_grp0, &ingenic_msc_mux_ops, CLK_SET_PARENT_GATE, X1021_CGU_HWDESC(CLK_CGU_MSCMUX)),
	X1021_CLK(CLK_CGU_MSC0, CLK_CGU_MSCMUX, &ingenic_msc_ops, 0, X1021_CGU_HWDESC(CLK_CGU_MSC0)),
	X1021_CLK(CLK_CGU_MSC1, CLK_CGU_MSCMUX, &ingenic_msc_ops, 0, X1021_CGU_HWDESC(CLK_CGU_MSC1)),
	X1021_CLK_MUX(CLK_CGU_SFC, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1021_CGU_HWDESC(CLK_CGU_SFC)),
	X1021_CLK_MUX(CLK_CGU_CIM, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1021_CGU_HWDESC(CLK_CGU_CIM)),
	X1021_CLK_MUX(CLK_CGU_SSI, cgu_ssi, &ingenic_ssi_mux_ops, CLK_SET_RATE_PARENT, X1021_CGU_HWDESC(CLK_CGU_SSI)),
	X1021_CLK_MUX(CLK_CGU_I2S, cgu_sel_grp0, &ingenic_audio_ops, 0, X1021_CGU_HWDESC(CLK_CGU_I2S)),


	/*gate*/
	X1021_CLK(CLK_GATE_NEMC, CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_NEMC)),
	X1021_CLK(CLK_GATE_EFUSE, CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_EFUSE)),
	X1021_CLK(CLK_GATE_OTG  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_OTG)),
	X1021_CLK(CLK_GATE_MSC0 , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_MSC0)),
	X1021_CLK(CLK_GATE_MSC1 , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_MSC1)),
	X1021_CLK(CLK_GATE_SSI0  , CLK_RATE_PCLK,&ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_SSI0)),
	X1021_CLK(CLK_GATE_I2C0 , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_I2C0)),
	X1021_CLK(CLK_GATE_I2C1 , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_I2C1)),
	X1021_CLK(CLK_GATE_AIC  , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_AIC)),
	X1021_CLK(CLK_GATE_SADC , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_SADC)),
	X1021_CLK(CLK_GATE_UART0, CLK_EXT, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_UART0)),
	X1021_CLK(CLK_GATE_UART1, CLK_EXT, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_UART1)),
	X1021_CLK(CLK_GATE_UART2, CLK_EXT, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_UART2)),
	X1021_CLK(CLK_GATE_SC_HASH , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_SC_HASH)),
	X1021_CLK(CLK_GATE_SSI1  , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_SSI1)),
	X1021_CLK(CLK_GATE_SFC  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_SFC)),
	X1021_CLK(CLK_GATE_PDMA , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_PDMA)),
	X1021_CLK(CLK_GATE_H1ARB , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_H1ARB)),
	X1021_CLK(CLK_GATE_TIZIANO  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_TIZIANO)),
	X1021_CLK(CLK_GATE_LCD , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_LCD)),
	X1021_CLK(CLK_GATE_RISCV , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_RISCV)),
	X1021_CLK(CLK_GATE_DES , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_DES)),
	X1021_CLK(CLK_GATE_RTC , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_RTC)),
	X1021_CLK(CLK_GATE_TCU , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_TCU)),
	X1021_CLK(CLK_GATE_DDR  , CLK_RATE_H0CLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1021_GATE_HWDESC(CLK_GATE_DDR)),
	X1021_CLK(CLK_GATE_HELIX , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_HELIX)),
	X1021_CLK(CLK_GATE_DTRNG , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_DTRNG)),
	X1021_CLK(CLK_GATE_IPU  , CLK_RATE_H0CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_IPU)),
	X1021_CLK(CLK_GATE_GMAC  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_GMAC)),
	X1021_CLK(CLK_GATE_AES  , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_AES)),
	X1021_CLK(CLK_GATE_AHB1 , CLK_RATE_H2CLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1021_GATE_HWDESC(CLK_GATE_AHB1)),
	X1021_CLK(CLK_GATE_AHB0 , CLK_RATE_H0CLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1021_GATE_HWDESC(CLK_GATE_AHB0)),
	X1021_CLK(CLK_GATE_SYS_OST  , CLK_RATE_L2CCLK, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_SYS_OST)),
	X1021_CLK(CLK_GATE_APB0 , CLK_RATE_PCLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1021_GATE_HWDESC(CLK_GATE_APB0)),
	X1021_CLK(CLK_GATE_CPU  , CLK_RATE_CPUCLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1021_GATE_HWDESC(CLK_GATE_CPU)),
	X1021_CLK(CLK_GATE_SCLKA, CLK_MUX_SCLKA, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1021_GATE_HWDESC(CLK_GATE_SCLKA)),
	X1021_CLK(CLK_GATE_USBPHY, CLK_EXT, &ingenic_gate_ops, 0,
		      X1021_GATE_HWDESC(CLK_GATE_USBPHY)),
	X1021_CLK(CLK_GATE_SCLKABUS, CLK_MUX_SCLKA,  &ingenic_gate_ops, CLK_IGNORE_UNUSED,
			X1021_GATE_HWDESC(CLK_GATE_SCLKABUS)),
	X1021_CLK_MUX(CLK_RTC, rtc_mux, &ingenic_rtc_ops, 0, &rtc_hwdesc),
};

static int x1021_clk_suspend(void)
{
	return 0;
}

static void x1021_clk_resume(void)
{
	return;
}

static struct syscore_ops x1021_syscore_ops = {
	.suspend = x1021_clk_suspend,
	.resume = x1021_clk_resume,
};
...
static void __init x1021_clk_init(struct device_node *np)
{
	...
	ingenic_clks_register(ctx, x1021_clk_init_data, ARRAY_SIZE(x1021_clk_init_data));

	register_syscore_ops(&x1021_syscore_ops);
	...
	{
		char *name[] = {"apll", "mpll", "vpll"};
		unsigned long rate[] = {0, 0, 0};
		struct clk *clk;
		int i;
		for (i = 0; i < 3; i++)  {
			clk = clk_get(NULL, name[i]);
		...
		printk("APLL:[%ld], MPLL:[%ld], VPLL:[%ld]\n", rate[0], rate[1], rate[2]);
	}

	return;
}
CLK_OF_DECLARE(x1021_clk, "ingenic,x1021-clocks", x1021_clk_init);
