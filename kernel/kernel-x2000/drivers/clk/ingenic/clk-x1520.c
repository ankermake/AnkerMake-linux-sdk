...
#include <dt-bindings/clock/ingenic-x1520.h>
...
#define X1520_CPCCR_HWDESC(_id) &cpccr_hwdesc[INDEX_CPCCR_HWDESC((_id))]
...
#define X1520_CGU_HWDESC(_id) &cgu_hwdesc[INDEX_CGU_HWDESC((_id))]
...
#define X1520_CLK_MUX(_id, _pids, _ops, _flags, _phwdesc)	\
		CLK_INIT_DATA_LOCKED(_id, _ops, _pids, ARRAY_SIZE(_pids), _flags, _phwdesc)

/*Note: parent num == 1, _pid is parent clock id*/
#define X1520_CLK(_id, _pid, _ops, _flags, _phwdesc)	\
	CLK_INIT_DATA_LOCKED(_id, _ops, _pid, 1, _flags, _phwdesc)

static const struct ingenic_clk_init __initdata x1520_clk_init_data[] = {
	/*pll*/
	X1520_CLK(CLK_PLL_APLL, CLK_EXT, &ingenic_pll_v2_ro_ops, CLK_IGNORE_UNUSED, &apll_hwdesc),
	X1520_CLK(CLK_PLL_MPLL, CLK_EXT, &ingenic_pll_v2_ro_ops, CLK_IGNORE_UNUSED, &mpll_hwdesc),
	/*cpccr*/
	X1520_CLK_MUX(CLK_MUX_SCLKA, sclk_a_p, &ingenic_cpccr_mux_ro_ops, 0, X1520_CPCCR_HWDESC(CLK_MUX_SCLKA)),
	X1520_CLK_MUX(CLK_MUX_CPLL, cpccr_p, &ingenic_cpccr_mux_ro_ops, 0, X1520_CPCCR_HWDESC(CLK_MUX_CPLL)),
	X1520_CLK_MUX(CLK_MUX_H0PLL, cpccr_p, &ingenic_cpccr_mux_ro_ops, 0, X1520_CPCCR_HWDESC(CLK_MUX_H0PLL)),
	X1520_CLK_MUX(CLK_MUX_H2PLL, cpccr_p, &ingenic_cpccr_mux_ro_ops, 0, X1520_CPCCR_HWDESC(CLK_MUX_H2PLL)),
	X1520_CLK(CLK_RATE_PCLK, CLK_MUX_H2PLL, &ingenic_cpccr_rate_ro_ops,0, X1520_CPCCR_HWDESC(CLK_RATE_PCLK)),
	X1520_CLK(CLK_RATE_H2CLK, CLK_MUX_H2PLL, &ingenic_cpccr_rate_ro_ops,0, X1520_CPCCR_HWDESC(CLK_RATE_H2CLK)),
	X1520_CLK(CLK_RATE_H0CLK, CLK_MUX_H0PLL, &ingenic_cpccr_rate_ro_ops,0, X1520_CPCCR_HWDESC(CLK_RATE_H0CLK)),
	X1520_CLK(CLK_RATE_CPUCLK, CLK_MUX_CPLL, &ingenic_cpccr_rate_ro_ops,0, X1520_CPCCR_HWDESC(CLK_RATE_CPUCLK)),
	X1520_CLK(CLK_RATE_L2CCLK, CLK_MUX_CPLL, &ingenic_cpccr_rate_ro_ops,0, X1520_CPCCR_HWDESC(CLK_RATE_L2CCLK)),
	/*cgu*/
	X1520_CLK_MUX(CLK_CGU_DDR, cgu_ddr, &ingenic_cgu_ops, CLK_IGNORE_UNUSED, X1520_CGU_HWDESC(CLK_CGU_DDR)),
	X1520_CLK_MUX(CLK_CGU_MAC, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1520_CGU_HWDESC(CLK_CGU_MAC)),
	X1520_CLK_MUX(CLK_CGU_ISP, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1520_CGU_HWDESC(CLK_CGU_ISP)),
	X1520_CLK_MUX(CLK_CGU_MSCMUX, cgu_sel_grp0, &ingenic_msc_mux_ops, CLK_SET_PARENT_GATE, X1520_CGU_HWDESC(CLK_CGU_MSCMUX)),
	X1520_CLK(CLK_CGU_MSC0, CLK_CGU_MSCMUX, &ingenic_msc_ops, 0, X1520_CGU_HWDESC(CLK_CGU_MSC0)),
	X1520_CLK(CLK_CGU_MSC1, CLK_CGU_MSCMUX, &ingenic_msc_ops, 0, X1520_CGU_HWDESC(CLK_CGU_MSC1)),
	X1520_CLK_MUX(CLK_CGU_SFC, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1520_CGU_HWDESC(CLK_CGU_SFC)),
	X1520_CLK_MUX(CLK_CGU_CIM, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1520_CGU_HWDESC(CLK_CGU_CIM)),
	X1520_CLK_MUX(CLK_CGU_SSI, cgu_ssi, &ingenic_ssi_mux_ops, CLK_SET_RATE_PARENT, X1520_CGU_HWDESC(CLK_CGU_SSI)),
	X1520_CLK_MUX(CLK_CGU_I2S, cgu_sel_grp0, &ingenic_audio_ops, 0, X1520_CGU_HWDESC(CLK_CGU_I2S)),
	X1520_CLK_MUX(CLK_CGU_USB, cgu_usb, &ingenic_cgu_ops, CLK_SET_PARENT_GATE, X1520_CGU_HWDESC(CLK_CGU_USB)),


	/*gate*/
	X1520_CLK(CLK_GATE_EFUSE, CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_EFUSE)),
	X1520_CLK(CLK_GATE_SFC  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_SFC)),
	X1520_CLK(CLK_GATE_OTG  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_OTG)),
	X1520_CLK(CLK_GATE_MSC0 , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_MSC0)),
	X1520_CLK(CLK_GATE_MSC1 , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_MSC1)),
	X1520_CLK(CLK_GATE_I2C0 , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_I2C0)),
	X1520_CLK(CLK_GATE_I2C1 , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_I2C1)),
	X1520_CLK(CLK_GATE_I2C2 , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_I2C2)),
	X1520_CLK(CLK_GATE_I2C3 , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_I2C3)),
	X1520_CLK(CLK_GATE_AIC  , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_AIC)),
	X1520_CLK(CLK_GATE_VPU0 , CLK_RATE_H0CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_VPU0)),
	X1520_CLK(CLK_GATE_SADC , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_SADC)),
	X1520_CLK(CLK_GATE_UART0, CLK_EXT, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_UART0)),
	X1520_CLK(CLK_GATE_UART1, CLK_EXT, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_UART1)),
	X1520_CLK(CLK_GATE_UART2, CLK_EXT, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_UART2)),
	X1520_CLK(CLK_GATE_DMIC , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_DMIC)),
	X1520_CLK(CLK_GATE_TCU  , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_TCU)),
	X1520_CLK(CLK_GATE_SSI0  , CLK_RATE_PCLK,&ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_SSI0)),
	X1520_CLK(CLK_GATE_SYS_OST  , CLK_RATE_L2CCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_SYS_OST)),
	X1520_CLK(CLK_GATE_PDMA , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_PDMA)),
	X1520_CLK(CLK_GATE_IPU  , CLK_RATE_H0CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_IPU)),
	X1520_CLK(CLK_GATE_ISP  , CLK_RATE_H0CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_ISP)),
	X1520_CLK(CLK_GATE_AES  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_AES)),
	X1520_CLK(CLK_GATE_MAC  , CLK_RATE_H2CLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_MAC)),
	X1520_CLK(CLK_GATE_RTC  , CLK_RATE_PCLK, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_RTC)),
	X1520_CLK(CLK_GATE_APB0 , CLK_RATE_PCLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1520_GATE_HWDESC(CLK_GATE_APB0)),
	X1520_CLK(CLK_GATE_AHB0 , CLK_RATE_H0CLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1520_GATE_HWDESC(CLK_GATE_AHB0)),
	X1520_CLK(CLK_GATE_CPU  , CLK_RATE_CPUCLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1520_GATE_HWDESC(CLK_GATE_CPU)),
	X1520_CLK(CLK_GATE_DDR  , CLK_RATE_H0CLK, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1520_GATE_HWDESC(CLK_GATE_DDR)),
	X1520_CLK(CLK_GATE_SCLKA, CLK_MUX_SCLKA, &ingenic_gate_ops, CLK_IGNORE_UNUSED,
		      X1520_GATE_HWDESC(CLK_GATE_SCLKA)),
	X1520_CLK(CLK_GATE_USBPHY, CLK_EXT, &ingenic_gate_ops, 0,
		      X1520_GATE_HWDESC(CLK_GATE_USBPHY)),
	X1520_CLK(CLK_GATE_SCLKABUS, CLK_MUX_SCLKA,  &ingenic_gate_ops, CLK_IGNORE_UNUSED,
			X1520_GATE_HWDESC(CLK_GATE_SCLKABUS)),
	X1520_CLK_MUX(CLK_RTC, rtc_mux, &ingenic_rtc_ops, 0, &rtc_hwdesc),
};

static int x1520_clk_suspend(void)
{
	return 0;
}

static void x1520_clk_resume(void)
{
	return;
}

static struct syscore_ops x1520_syscore_ops = {
	.suspend = x1520_clk_suspend,
	.resume = x1520_clk_resume,
};
...
static void __init x1520_clk_init(struct device_node *np)
{
	...
	ingenic_clks_register(ctx, x1520_clk_init_data, ARRAY_SIZE(x1520_clk_init_data));

	register_syscore_ops(&x1520_syscore_ops);
...
CLK_OF_DECLARE(x1520_clk, "ingenic,x1520-clocks", x1520_clk_init);
