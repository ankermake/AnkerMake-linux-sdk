		       ...
		       unsigned int cmd, void *arg)
{
	...
	case UVCIOC_GET_INTF_CONTROL_STREAMING:
	{
		struct uvc_interface_id *interface_id = arg;
		interface_id->control_intf_id = uvc->control_intf;
		interface_id->streaming_intf_id = uvc->streaming_intf;
		return 0;
	}
