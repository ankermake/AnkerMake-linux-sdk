...
static const struct UVC_FRAME_UNCOMPRESSED(2) uvc_frame_yuv_480p = {
	...
	.dwMinBitRate		= cpu_to_le32(73728000),
...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_yuv_1080p = {
	...
	.dwMaxBitRate		= cpu_to_le32(464486400),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(4147200),
	.dwDefaultFrameInterval	= cpu_to_le32(710000),
	.bFrameIntervalType	= 1,
	.dwFrameInterval[0]	= cpu_to_le32(710000),
};
...
static const struct UVC_FRAME_MJPEG(2) uvc_frame_mjpg_480p = {
