...
#define MUX_PRIORITY_BIT	(12)
#define MUX_PRIORITY_MSK	(0xfffff << PRIORITY_BIT)
#define PRI_HELIX_BIT		(30)
#define PRI_HELIX_MSK		(0x3 <<	PRI_HELIX_BIT)
#define PRI_FELIX_BIT		(28)
#define PRI_FELIX_MSK		(0x3 <<	PRI_FELIX_BIT)
#define PRI_ISP0_BIT		(26)
#define PRI_ISP0_MSK		(0x3 <<	PRI_ISP0_BIT)
#define PRI_ISP1_BIT		(24)
#define PRI_ISP1_MSK		(0x3 <<	PRI_ISP1_BIT)
#define PRI_LCD_BIT		(22)
#define PRI_LCD_MSK		(0x3 <<	PRI_LCD_BIT)
#define PRI_CIM_BIT		(20)
#define PRI_CIM_MSK		(0x3 <<	PRI_CIM_BIT)
#define PRI_ROTATE_BIT		(18)
#define PRI_ROTATE_MSK		(0x3 <<	PRI_ROTATE_BIT)
