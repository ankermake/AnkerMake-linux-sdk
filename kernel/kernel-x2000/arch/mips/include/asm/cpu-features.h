...
#if 0 //remove auto feature detect, must be defined in cpu-feature-overrides.h
#ifndef cpu_has_mxu
#define cpu_has_mxu		(cpu_data[0].ases & MIPS_ASE_XBURSTMXU)
#endif
#ifndef cpu_has_mxuv2
#define cpu_has_mxuv2		(cpu_data[0].ases & MIPS_ASE_XBURSTMXUV2)
#endif
#else
