#ifndef _DT_BINDINGS_CLOCK_X1630_H
#define _DT_BINDINGS_CLOCK_X1630_H
...
#define CLK_GATE_I2C2		(CLK_ID_GATE + 8)
...
#define CLK_GATE_ISP		(CLK_ID_GATE + 18)
#define CLK_GATE_LCD		(CLK_ID_GATE + 19)
#define CLK_GATE_MIPI_CSI		(CLK_ID_GATE + 20)
...
#define CLK_GATE_NCU		(CLK_ID_GATE + 28)
#define CLK_GATE_GMAC		(CLK_ID_GATE + 29)
#define CLK_GATE_AES		(CLK_ID_GATE + 30)
#define CLK_GATE_AHB1		(CLK_ID_GATE + 31)
#define CLK_GATE_MSCALER		(CLK_ID_GATE + 32)
#define CLK_GATE_LDC		(CLK_ID_GATE + 33)
#define CLK_GATE_AHB0		(CLK_ID_GATE + 34)
#define CLK_GATE_SYS_OST	(CLK_ID_GATE + 35)
#define CLK_GATE_RADIX	(CLK_ID_GATE + 36)
#define CLK_GATE_APB0		(CLK_ID_GATE + 37)
#define CLK_GATE_CPU		(CLK_ID_GATE + 38)
#define CLK_GATE_SCLKA		(CLK_ID_GATE + 39)
#define CLK_GATE_USBPHY		(CLK_ID_GATE + 40)
#define CLK_GATE_SCLKABUS	(CLK_ID_GATE + 41)
