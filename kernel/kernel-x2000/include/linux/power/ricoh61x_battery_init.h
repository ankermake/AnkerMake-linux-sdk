...
#ifdef CONFIG_130MAH_FSHD_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
	{
		0x0B, 0x25, 0x0B, 0xD6, 0x0B, 0xF7, 0x0C, 0x10,
		0x0C, 0x24, 0x0C, 0x3D, 0x0C, 0x60, 0x0C, 0x9B,
		0x0C, 0xCD, 0x0D, 0x15, 0x0D, 0x65, 0x00, 0x8A,
		0x02, 0x94, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
	}
};
#endif

#ifdef CONFIG_160MAH_DV010_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
	{
		0x0B, 0x15, 0x0B, 0xD3, 0x0B, 0xF4, 0x0C, 0x0C,
		0x0C, 0x20, 0x0C, 0x39, 0x0C, 0x5F, 0x0C, 0x99,
		0x0C, 0xCC, 0x0D, 0x0F, 0x0D, 0x65, 0x00, 0x9E,
		0x02, 0x67, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
	}
};
#endif
...
#ifdef CONFIG_140MAH_ZBRGLASS_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = { 
        {   
	        0x0B, 0x19, 0x0B, 0xCD, 0x0B, 0xF7, 0x0C, 0x12,
		0x0C, 0x23, 0x0C, 0x3B, 0x0C, 0x62, 0x0C, 0x9B,
		0x0C, 0xCF, 0x0D, 0x11, 0x0D, 0x6B, 0x00, 0x91,
		0x01, 0x9A, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56 
	}   
};
#endif

#ifdef CONFIG_310MAH_JZZHG9_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
        {
	        0x0B, 0x54, 0x0B, 0xD5, 0x0B, 0xFA, 0x0C, 0x0F, 
		0x0C, 0x21, 0x0C, 0x3A, 0x0C, 0x5E, 0x0C, 0x95, 
		0x0C, 0xC2, 0x0D, 0x0C, 0x0D, 0x61, 0x01, 0x38, 
		0x01, 0xEA, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
	}
};
#endif
...
uint8_t battery_init_para[][32] = {
        {
	        0x0B, 0x43, 0x0B, 0xC9, 0x0B, 0xEE, 0x0C, 0x09,
		0x0C, 0x19, 0x0C, 0x28, 0x0C, 0x3E, 0x0C, 0x67,
		0x0C, 0x93, 0x0C, 0xBB, 0x0D, 0x00, 0x01, 0x7C,
		0x01, 0x04, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
        }
}; 
#endif

#ifdef CONFIG_370MAH_CLOFY_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
        {
	        0x0B, 0x39, 0x0B, 0xBB, 0x0B, 0xDC, 0x0B, 0xF7,
		0x0C, 0x12, 0x0C, 0x32, 0x0C, 0x57, 0x0C, 0x89,
		0x0C, 0xCF, 0x0D, 0x10, 0x0D, 0xAE, 0x03, 0x9E,
		0x00, 0xA1, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
	}
}; 
#endif

#ifdef CONFIG_400MAH_DISATCH_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
        {
               0x09, 0xCC, 0x0B, 0x9F, 0x0B, 0xD9, 0x0B, 0xF7, 
	       0x0C, 0x0A, 0x0C, 0x20, 0x0C, 0x3F, 0x0C, 0x6C, 
	       0x0C, 0xA3, 0x0C, 0xE7, 0x0D, 0x61, 0x01, 0x90, 
	       0x00, 0x8E, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
	}
}; 
#endif

#ifdef CONFIG_480MAH_DISATCH_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
        {
	      0x0B, 0x33, 0x0B, 0x46, 0x0B, 0xB9, 0x0B, 0xEA,
	      0x0C, 0x0A, 0x0C, 0x1D, 0x0C, 0x30, 0x0C, 0x52,
	      0x0C, 0x8A, 0x0C, 0xBA, 0x0D, 0x03, 0x01, 0xB1,
	      0x00, 0xEB, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56 
	}
}; 
#endif
...
uint8_t battery_init_para[][32] = {
	{
	        0x0A, 0x0A, 0x0B, 0xB9, 0x0B, 0xE3, 0x0B, 0xFD,
		0x0C, 0x14, 0x0C, 0x35, 0x0C, 0x63, 0x0C, 0xA2,
		0x0C, 0xFB, 0x0D, 0x52, 0x0D, 0xD2, 0x07, 0xD0,
		0x00, 0x4E, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56 
	}
};
#endif

#ifdef CONFIG_2200MAH_ZBRZFY_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
    {
                0x0A, 0x26, 0x0B, 0xD3, 0x0B, 0xFD, 0x0C, 0x16, 
		0x0C, 0x2C, 0x0C, 0x4D, 0x0C, 0x87, 0x0C, 0xC7, 
		0x0D, 0x1D, 0x0D, 0x73, 0x0D, 0xDF, 0x08, 0xA4, 
...
#ifdef CONFIG_2500MAH_ZYCZZFY_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
       {
	       0x0B, 0x3D, 0x0B, 0xD5, 0x0B, 0xFA, 0x0C, 0x12, 
	       0x0C, 0x27, 0x0C, 0x3F, 0x0C, 0x63, 0x0C, 0x9E, 
	       0x0C, 0xCF, 0x0D, 0x13, 0x0D, 0x61, 0x09, 0x3B, 
	       0x00, 0x52, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
       }
};
#endif
...
#ifdef CONFIG_10000MAH_ZBRZFY_C_CAPACITY_BATTERY
uint8_t battery_init_para[][32] = {
        {
	        0x0A, 0x44, 0x0A, 0xFF, 0x0B, 0x3D, 0x0B, 0x63,
		0x0B, 0x81, 0x0B, 0xA3, 0x0B, 0xD3, 0x0C, 0x1B,
		0x0C, 0x73, 0x0C, 0xD4, 0x0D, 0x61, 0x27, 0x10,
		0x00, 0x25, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
i	}
}; 
#endif

#ifdef CONFIG_250MAH_CIRCLEV2_CAPACITY_BATTERY
/*for circlev2 250mA*/
uint8_t battery_init_para[][32] = {
	{
		0x0B, 0x16, 0x0B, 0xD7, 0x0B, 0xFF, 0x0C, 0x14, 
		0x0C, 0x2D, 0x0C, 0x52, 0x0C, 0x88, 0x0C, 0xCB, 
		0x0D, 0x1F, 0x0D, 0x75, 0x0D, 0xE2, 0x01, 0x04, 
		0x01, 0xA9, 0x0F, 0xC8, 0x05, 0x2C, 0x22, 0x56
	}
};
#endif
