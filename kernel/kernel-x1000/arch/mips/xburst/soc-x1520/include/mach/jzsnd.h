...
int jz_speaker_init(struct device *dev);
void jz_speaker_deinit(struct device *dev);
int jz_speaker_enable(bool enable);
...
struct snd_codec_data {
    ...
    int hp_max_volume_regval;
    int hp_min_volume_regval;
    int hp_default_volume_regval;
