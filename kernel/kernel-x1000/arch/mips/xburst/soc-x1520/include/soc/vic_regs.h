...
#define IRQ_CNT0    (VIC_IRQ_OFF + 0x00)
#define IRQ_CNTC1   (VIC_IRQ_OFF + 0x04)
#define IRQ_CNTCA   (VIC_IRQ_OFF + 0x08)
#define IRQ_SRC     (VIC_IRQ_OFF + 0x0c)
#define IRQ_CNT_OVF (VIC_IRQ_OFF + 0x10)
#define IRQ_EN      (VIC_IRQ_OFF + 0x14)
#define VIC_IRQ_MSK     (VIC_IRQ_OFF + 0x1C)
#define IRQ_CNT1    (VIC_IRQ_OFF + 0x20)
#define IRQ_CNT2    (VIC_IRQ_OFF + 0x24)
...
#define VIC_START_EN   (1 << 0)
#define VIC_GLB_SAFE_RST_EN   (1 << 3)
#define VIC_RESET_EN   (1 << 4)
#define REG_ENABLE_EN   (1 << 1)
#define ST_DMA_DVP_OVF (1 << 24)
#define ST_DMA_FRD (1 << 23)
#define ST_CORE_FIFO_FAIL (1 << 22)
#define ST_VIC_HVF (1 << 21)
#define ST_VIC_IMVE (1 << 20)
#define ST_VIC_IMHE (1 << 19)
#define ST_VIC_MIPI_OVF (1 << 18)
#define ST_VIC_DVP_OVF (1 << 17)
#define ST_VIC_FRD (1 << 16)
#define DMA_RESET_EN    (1 << 0)
