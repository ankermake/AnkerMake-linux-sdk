...
#elif (defined(CONFIG_SOC_T20) || defined(CONFIG_SOC_T30) || defined(CONFIG_SOC_X1520))
...
#define FIRST_FIELD_ODD_TYPE		(0<<3)
#define FIRST_FIELD_EVEN_TYPE		(1<<3)

#define PROGRESSIVE_EN				(0<<2)
#define INTERLACE_EN			(1<<2)
