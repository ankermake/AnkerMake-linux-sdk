...
void jz_otg_phy_init(otg_mode_t mode)
{
	...
	/*pcr*/
	usbpcr = USBPCR_TXRISETUNE | USBPCR_COMMONONN | USBPCR_VBUSVLDEXT | USBPCR_VBUSVLDEXTSEL |
		USBPCR_COMPDISTUNE(4) | USBPCR_OTGTUNE(4) | USBPCR_SQRXTUNE(3) |
		USBPCR_TXFSLSTUNE(3) | USBPCR_TXPREEMPHTUNE | USBPCR_TXHSXVTUNE(3) |
		USBPCR_TXVREFTUNE(15);
