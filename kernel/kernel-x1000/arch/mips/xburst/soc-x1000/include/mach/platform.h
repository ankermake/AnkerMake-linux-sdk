...
#define UART1_PORTD_CTS							\
	{ .name = "uart1-pd-cts", .port = GPIO_PORT_D, .func = GPIO_FUNC_1, .pins = 0x3 << 4, }
#define UART2_PORTA							\
...
#define SSI0_PORTA_22BIT						\
       { .name = "ssi0-pa", .port = GPIO_PORT_A, .func = GPIO_FUNC_2, .pins = 0xf << 22, }
...
#define SLCDC_PORTB_TE							\
        { .name = "slcd", .port = GPIO_PORT_B, .func = GPIO_FUNC_1, .pins = 0x08 << 16, }
/****************************************************************************************/
