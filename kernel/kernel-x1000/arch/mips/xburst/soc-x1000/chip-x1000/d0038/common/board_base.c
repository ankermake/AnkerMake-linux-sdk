...
#define DEF_DEVICE(DEVICE, DATA, SIZE)  \
	...
	DEF_DEVICE(&jz_matrix_keypad_device, 0, 0),
#endif
...
#if defined(CONFIG_USB_JZ_DWC2) || defined(CONFIG_USB_NDWC2)
...
/* JZ LCD driver */
	...
	DEF_DEVICE(&frd20024n_device, 0, 0),
#endif
/* end of LCD driver */
...
#ifdef CONFIG_BACKLIGHT_PWM
extern void backlight_pwm_add_table(void);
#endif
