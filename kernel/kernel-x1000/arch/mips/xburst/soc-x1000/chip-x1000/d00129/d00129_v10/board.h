...
#define GPIO_PULL_VOLUMEUP	1

#define GPIO_VOLUME_DOWN	GPIO_PC(21)
#define ACTIVE_LOW_VOLUMEDOWN	1
#define GPIO_PULL_VOLUMEDOWN	1

#define GPIO_VOICE		GPIO_PB(25)
#define ACTIVE_LOW_VOICE	1
#define GPIO_PULL_VOICE		0

#define GPIO_PLAY_PAUSE		GPIO_PA(25)
#define ACTIVE_LOW_PLAYPAUSE	1
#define GPIO_PULL_PLAYPAUSE	1

#define GPIO_BAT_DETECT		GPIO_PA(6)
#define ACTIVE_LOW_BAT_DETECT	1

#define GPIO_DC_DETECT		GPIO_PA(4)
#define ACTIVE_LOW_DC_DETECT	0
/* ****************************GPIO KEY END******************************** */
...
#define GPIO_AK4951_PDN           GPIO_PA(22)
/* ****************************GPIO AUDIO END******************************** */
