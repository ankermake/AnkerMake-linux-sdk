...
#define DEF_CLK(N,FLAG)						\
	...
	DEF_CLK(SSI0,       GATE(6) | PARENT(EXT1)),
	DEF_CLK(SSI1,  		GATE(19) | PARENT(EXT1)),
#else
	DEF_CLK(SSI0,        GATE(6) | PARENT(CGU_SFC)),
	DEF_CLK(SSI1,  		GATE(19) | PARENT(CGU_SFC)),
#endif
	...
	DEF_CLK(MSCALER,	GATE(32 + 8) | PARENT(H0CLK)),/*x1830 only*/
	DEF_CLK(LDC,		GATE(32 + 9) | PARENT(H0CLK)),/*x1830 only*/
