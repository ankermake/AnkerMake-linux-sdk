...
#define CLK_NAME_VPLL		"vpll"
	CLK_ID_EPLL,
#define CLK_NAME_EPLL		"epll" /*x1830 only*/
...
#define CLK_NAME_AIC		"aic"
	CLK_ID_I2C2,
#define CLK_NAME_I2C2		"i2c2" /* x1830 only */
	CLK_ID_I2C1,
...
#define CLK_NAME_RADIX0	        "radix0" /* radix */
	CLK_ID_LDC,
#define CLK_NAME_LDC	        "ldc" /* x1830 only */
	CLK_ID_MSCALER,
#define CLK_NAME_MSCALER	    "mscaler" /* x1830 only */
...
enum {	//SHOULD BE CHECKED!!
	CGU_ISP, CGU_CIM,CGU_SFC,CGU_SSI,
	CGU_I2S,CGU_MSC1,CGU_MSC0,CGU_MACPHY,
	CGU_VPU,CGU_DDR,CGU_MSC_MUX,CGU_LPC
};
