...
struct jz_gpio_func_def platform_devio_array[] = {
	...
	MSC0_PORTB_4BIT,
#endif
#ifdef CONFIG_JZMMC_V12_MMC0_PB_1BIT
	MSC0_PORTB_1BIT,
#endif
...
#if defined(CONFIG_SND_ASOC_JZ_EXTCODEC) || defined(CONFIG_JZ_MICCHAR_I2S_MASTER) || defined(CONFIG_JZ_MICCHAR_I2S_SLAVE)
    I2S_DAC_PORTC,
    I2S_ADC_PORTC,
    I2S_MCLK_PORTC,
#endif
...
#if defined(CONFIG_SND_ASOC_JZ_DMIC_V13) || defined(CONFIG_JZ_MICCHAR) || defined(CONFIG_x1800_MIC)
    #if defined(CONFIG_DMIC_DATA0)
        DMIC_PORTC_DATA0,
    #elif defined(CONFIG_DMIC_DATA1)
        DMIC_PORTC_DATA1,
    #elif defined(CONFIG_DMIC_DATA_DOUBLE)
        DMIC_PORTC,
    #endif
#endif

#ifdef CONFIG_LCD_V14_SLCD_8BIT
	DPU_PORTD_SLCD_8BIT,
#endif

#ifdef CONFIG_LCD_V14_SLCD_9BIT
	DPU_PORTD_SLCD_9BIT,
#endif

#ifdef CONFIG_LCD_V14_SLCD_16BIT
	DPU_PORTD_SLCD_16BIT,
#endif

#ifdef CONFIG_LCD_V14_TFT_18BIT
	DPU_PORTD_TFT_18BIT,
#endif

#ifdef CONFIG_JZ_MAC_V13
	GMAC_PORTB,
#endif
};
...
struct platform_device jz_dmic_dump_cdc_device = {
	.name           = "dmic dump",
	.id             = -1,
};
#endif
...
#elif defined(CONFIG_JZ_MICCHAR) || defined(CONFIG_x1800_MIC)
