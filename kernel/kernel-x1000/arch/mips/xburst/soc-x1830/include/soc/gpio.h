...
enum gpio_function {
	...
	/*func group 1 : final function can be (group0 | group1)*/
	GPIO_PULL_FUNC	= 0x80,
	...
	GPIO_DRIVE_FUNC = 0x800,
	GPIO_DRIVE_2MA = GPIO_DRIVE_FUNC|0x000, //drive strength 2mA
	GPIO_DRIVE_4MA = GPIO_DRIVE_FUNC|0x100, //drive strength 4mA
	GPIO_DRIVE_8MA = GPIO_DRIVE_FUNC|0x200, //drive strength 8mA
	GPIO_DRIVE_12MA = GPIO_DRIVE_FUNC|0x300, //drive strength 12mA

	GPIO_RATE_FUNC = 0x2000,
	GPIO_RATE_SLOW = 0x2000,	//slew rate slow(half frequency)
	GPIO_RATE_FAST = 0x3000,	//slew rate fast

	GPIO_SMT_FUNC = 0x8000,
