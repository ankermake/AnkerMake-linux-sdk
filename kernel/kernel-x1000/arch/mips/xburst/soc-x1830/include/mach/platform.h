...
#define MSC0_PORTB_1BIT							\
	...
	{ .name = "msc0-pb-cd",		.port = GPIO_PORT_B, .func = GPIO_OUTPUT1, .pins = (0x8<<0), }	/*card detect pin SPI/SD mode*/
#define MSC1_PORTC_4BIT							\
	{ .name = "msc1-pc-clk",	.port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = (0x1<<2), }, \
	{ .name = "msc1-pc-4bit",	.port = GPIO_PORT_C, .func = GPIO_FUNC_0|GPIO_PULL_UP, .pins = (0x3e<<2), }
...
#define I2S_MCLK_PORTC                           \
	{.name = "i2s-mclk",    .port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = (0x1 << 23),}

/*******************************************************************************************************************/
/*****************************************************************************************************************/

#define SSI0_PORTC							\
	{ .name = "ssi0-pc",	       .port = GPIO_PORT_C, .func = GPIO_FUNC_0, .pins = 0x09800, }
#define SSI0_PORTD							\
	{ .name = "ssi1-pd",	       .port = GPIO_PORT_D, .func = GPIO_FUNC_2, .pins = 0x0004C, }
...
#define DMIC_PORTC_DATA0							\
	{ .name = "dmic_pc",	.port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins = 0x1<<8 | 0x1 << 25}
#define DMIC_PORTC_DATA1							\
	{ .name = "dmic_pc",	.port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins = 0x1<<8 | 0x2 << 25}
