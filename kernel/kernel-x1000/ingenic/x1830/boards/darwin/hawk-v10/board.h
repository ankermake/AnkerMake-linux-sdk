 ...
 * Key GPIO
 */
#define GPIO_HOME                       GPIO_PB(17)
#define ACTIVE_LOW_HOME                 (1)
#define GPIO_LEFT                       GPIO_PC(00)
#define ACTIVE_LOW_LEFT                 (1)
#define GPIO_DOWN                       GPIO_PC(24)
#define ACTIVE_LOW_DOWN                 (1)
#define GPIO_RIGHT                      GPIO_PC(17)
#define ACTIVE_LOW_RIGHT                (1)
#define GPIO_UP                         GPIO_PC(21)
#define ACTIVE_LOW_UP                   (1)
#define GPIO_MENU                       GPIO_PB(31)
...
#ifdef CONFIG_TX_ISP_CAMERA_OV2735B
#define CIM1_SENSOR_NAME                "ov2735b"
#define CIM1_GPIO_POWER                 GPIO_PB(30)
#define CIM1_GPIO_SENSOR_PWDN           (-1)
#define CIM1_GPIO_SENSOR_RST            GPIO_PA(19)
...
#ifdef CONFIG_TX_ISP_CAMERA_AR0144
#define CIM1_SENSOR_NAME                "ar0144"
#define CIM1_GPIO_POWER                 (-1)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PB(30)
#define CIM1_GPIO_SENSOR_RST            GPIO_PB(29)
#define CIM1_GPIO_I2C_SEL1              (-1)
#define CIM1_GPIO_I2C_SEL2              (-1)
#define CIM1_DVP_GPIO_FUNC              (-1)
#endif
