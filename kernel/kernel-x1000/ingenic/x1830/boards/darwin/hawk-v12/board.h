...
#ifdef CONFIG_TX_ISP_CAMERA_AR0522
#define CIM1_SENSOR_NAME                "ar0522"
#define CIM1_GPIO_POWER                 (-1)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PA(9)
#define CIM1_GPIO_SENSOR_RST            GPIO_PA(19)
#define CIM1_GPIO_I2C_SEL1              GPIO_PA(18)
#define CIM1_GPIO_I2C_SEL2              (-2)
#define CIM1_DVP_GPIO_FUNC              (-1)
#endif

#ifdef CONFIG_TX_ISP_CAMERA_GC2385
#define CIM1_SENSOR_NAME                "gc2385"
#define CIM1_GPIO_POWER                 GPIO_PA(18)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PA(20)
...
#ifdef CONFIG_TX_ISP_CAMERA_AR0144_DVP
#define CIM1_SENSOR_NAME                "ar0144"
#define CIM1_GPIO_POWER                 GPIO_PA(2)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PC(11)
#define CIM1_GPIO_SENSOR_RST            (-1)
#define CIM1_GPIO_I2C_SEL1              (-1)
#define CIM1_GPIO_I2C_SEL2              (-1)
#define CIM1_DVP_GPIO_FUNC              DVP_PA_HIGH_8BIT
#endif

#ifdef CONFIG_TX_ISP_CAMERA_AR0144_MIPI
#define CIM1_SENSOR_NAME                "ar0144"
#define CIM1_GPIO_POWER                 (-1)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PA(15)
#define CIM1_GPIO_SENSOR_RST            GPIO_PA(9)
#define CIM1_GPIO_I2C_SEL1              (-1)
#define CIM1_GPIO_I2C_SEL2              (-1)
#define CIM1_DVP_GPIO_FUNC              (-1)
#endif

#ifdef CONFIG_TX_ISP_CAMERA_OV7740
#define CIM1_SENSOR_NAME                "ov7740"
#define CIM1_GPIO_POWER                 GPIO_PB(30)
#define CIM1_GPIO_SENSOR_PWDN           (-1)
#define CIM1_GPIO_SENSOR_RST            GPIO_PA(19)
#define CIM1_GPIO_I2C_SEL1              GPIO_PA(18)
...
#ifdef CONFIG_TX_ISP_CAMERA_AR0234_MIPI
#define CIM1_SENSOR_NAME                "ar0234"
#define CIM1_GPIO_POWER                 (-1)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PA(15)
#define CIM1_GPIO_SENSOR_RST            GPIO_PA(9)
#define CIM1_GPIO_I2C_SEL1              (-1)
...
#ifdef CONFIG_TX_ISP_CAMERA_BF2253L_MIPI
#define CIM1_SENSOR_NAME                "bf2253l"
#define CIM1_GPIO_POWER                 (-1)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PA(20)
#define CIM1_GPIO_SENSOR_RST            GPIO_PA(19)
#define CIM1_GPIO_I2C_SEL1              (-1)
...
#ifdef CONFIG_TX_ISP_CAMERA_S5K6A1_MIPI
#define CIM1_SENSOR_NAME                "s5k6a1"
#define CIM1_GPIO_POWER                 GPIO_PB(30)
#define CIM1_GPIO_SENSOR_PWDN           GPIO_PA(20)
#define CIM1_GPIO_SENSOR_RST            GPIO_PA(18)
#define CIM1_GPIO_I2C_SEL1              (-1)
