...
struct snd_codec_data __attribute__((weak)) codec_data = {
#if  defined(CONFIG_X1800_MIC_SND_INTERNAL_CODEC) || defined(CONFIG_JZ_INTERNAL_CODEC_V12)
	.codec_sys_clk = 0 ,
	.codec_dmic_clk = 0,
	/* volume */
	...
	.hp_min_volume_regval = HP_MIN_VOLUME_REGVAL,
	.hp_default_volume_regval = HP_DEFAULT_VOLUME_REGVAL,
#endif
};
