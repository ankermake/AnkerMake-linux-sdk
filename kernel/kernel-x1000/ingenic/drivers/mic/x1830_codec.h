/*
 * ingenic/drivers/mic/x1830_codec.c
 *
 * Base On sound/soc/ingenic/icodec/icdc_d4.h
 * micchar -- internal codec (x1830 codec) driver

 * Copyright 2018 Ingenic Semiconductor Co.,Ltd
 *	cli <chen.li@ingenic.com>
 *
 * Note: x1830_codec.h is an internal codec for jz SOC
...
#define ICDC_CGR	 0x00  /*0x03*/
#define ICDC_CACR	 0x08  /*0x50*/
#define ICDC_CMCR	 0x0C  /*0x0e*/
#define ICDC_CDC1R	 0x10  /*0x50*/
#define ICDC_CDC2R	 0x14  /*0x0e*/
#define ICDC_CADR	 0x1C  /*0x00*/
#define ICDC_CGAINR	 0x28  /*0x00*/
#define ICDC_CASR	 0x34  /*0x00*/
#define ICDC_CDPR	 0x38  /*0x03*/
#define ICDC_CDDPR2	 0x3C  /*0xff*/
#define ICDC_CDDPR1	 0x40  /*0xe0*/
#define ICDC_CDDPR0	 0x44  /*0x00*/
#define ICDC_CAACR	 0x84  /*0x00*/
#define ICDC_CMICCR	 0x88  /*0x00*/
#define ICDC_CACR2	 0x8C  /*0x0c*/
#define ICDC_CAMPCR	 0x90  /*0x00*/
#define ICDC_CAR	 0x94  /*0x00*/
#define ICDC_CHR	 0x98  /*0x00*/
#define ICDC_CHCR	 0x9C  /*0x40*/
#define ICDC_CCR	 0xA0  /*0x1e*/
#define ICDC_CMR	 0x100 /*0x00*/
#define ICDC_CTR	 0x104 /*0x46*/
#define ICDC_CAGCCR	 0x108 /*0x41*/
#define ICDC_CPGR	 0x10C /*0x2c*/
#define ICDC_CSRR	 0x110 /*0x00*/
#define ICDC_CALMR	 0x114 /*0x26*/
#define ICDC_CAHMR	 0x118 /*0x40*/
#define ICDC_CALMINR	 0x11c /*0x36*/
#define ICDC_CAHMINR	 0x120 /*0x20*/
#define ICDC_CAFR	 0x124 /*0x38*/
#define ICDC_CCAGVR	 0x130 /*0x0c*/
