...
// AW9163 initial register @ mobile active AW_NormalMode()
...
#define N_SCFG2					0x0283			// bit0~3 is sense seting
#define N_OFR1					0x1515			// offset
#define N_OFR2					0x1515			// offset
#define N_OFR3					0x1515			// offset
#define N_THR0					0x4045			// S1 press thred setting
#define N_THR1					0x4045			// S2 press thred setting
#define N_THR2					0x4045			// S3 press thred setting
#define N_THR3					0x4045			// S4 press thred setting
#define N_THR4					0x4045			// S5 press thred setting
#define N_THR5					0x4045			// S6 press thred setting
#define N_SETCNT				0x0202			// debounce
#define N_BLCTH					0x0402			// base trace rate 
#define N_AKSR					0x001c			// AKS 
#define N_INTER					0x001f			// signel click interrupt 
...
// AW9163 initial register @ mobile sleep AW_SleepMode()
