/* drivers/input/touchscreen/gt917s_generic.h
*
...
#ifndef _GT917S_GENERIC_H_
#define _GT917S_GENERIC_H_
...
#define GT917S_DEBUG_PROC_FILE        "gt917s_debug"
...
#define GTP_BAK_REF_PATH                "/data/gt917s_ref.bin"
#define GTP_MAIN_CLK_PATH               "/data/gt917s_clk.bin"
...
/* Export from gt917s_extents.c and gt917s_firmware.h */
#ifdef CONFIG_GTP_HOTKNOT
extern u8 hotknot_enabled;
extern u8 hotknot_transfer_mode;
extern u8 gt917s_patch_jump_fw[];
...
extern s32 gt917s_init_node(void);
extern void gt917s_deinit_node(void);

#ifdef CONFIG_GTP_GESTURE_WAKEUP
extern DOZE_T gesture_doze_status;
extern int gesture_enabled;
extern void gt917s_gesture_debug(int on) ;
...
/* Export from gt917s_tpd.c */
extern void gt917s_touch_down(s32 x, s32 y, s32 size, s32 id);
extern void gt917s_touch_up(s32 id);
extern int gt917s_power_switch(s32 state);
extern void gt917s_irq_enable(void);
extern void gt917s_irq_disable(void);
extern int gt917s_debug_proc(u8 * buf, int count);
...
/* Export form gt917s_update.c */
extern struct fw_update_info update_info;

extern u8 gt917s_default_FW[];
extern int gt917s_hold_ss51_dsp(void);
extern int gt917s_auto_update_proc(void *data);
extern int gt917s_update_firmware(void *filename);

extern void gt917s_enter_update_mode(void);
extern void gt917s_leave_update_mode(void);
extern int gt917s_hold_ss51_dsp_no_reset(void);
extern int gt917s_load_patch(u8 * patch, u32 patch_size, int offset, int bank_size);
extern int gt917s_startup_patch(void);

/* Export from gt917s_tool.c */
#ifdef CONFIG_GTP_CREATE_WR_NODE
extern int gt917s_init_tool_node(void);
extern void gt917s_deinit_tool_node(void);
#endif

/* Export from gt917s_generic.c */
extern struct i2c_client *gt917s_i2c_client;

extern gt917s_chip_type_t gt917s_chip_type;
extern struct gt917s_version_info gt917s_version;
...
extern s32 gt917s_i2c_write(u16 addr, u8 * buffer, s32 len);
extern s32 gt917s_i2c_read(u16 addr, u8 * buffer, s32 len);
extern s32 gt917s_i2c_read_dbl_check(u16 addr, u8 * buffer, s32 len);

extern u8 gt917s_int_type;
extern u32 gt917s_abs_x_max;
extern u32 gt917s_abs_y_max;
extern u8 gt917s_init_failed;
extern int gt917s_halt;
extern volatile int gt917s_rawdiff_mode;

extern s32 gt917s_init(void);
extern void gt917s_deinit(void);
extern s32 gt917s_read_version(struct gt917s_version_info *ver_info);
extern s32 gt917s_init_panel(void);
extern s32 gt917s_get_chip_type(void);
extern s32 gt917s_request_event_handler(void);
extern int gt917s_send_cmd(u8 cmd, u8 data);
extern s32 gt917s_send_cfg(u8 * config, int cfg_len);
extern void gt917s_select_addr(void);
extern s32 gt917s_reset_guitar(void);
extern void gt917s_power_reset(void);
extern int gt917s_parse_config(char *filename, u8 * gt917s_config);
extern s32 gt917s_touch_event_handler(u8 * data, struct input_dev *dev, struct input_dev *pen_dev);
extern int gt917s_suspend(void);
extern int gt917s_resume(void);

#ifdef CONFIG_GTP_HAVE_TOUCH_KEY
extern const u16 gt917s_touch_key_array[];
#endif

#ifdef CONFIG_GTP_WITH_STYLUS
extern struct input_dev *pen_dev;
extern void gt917s_pen_up(s32 id);
extern void gt917s_pen_down(s32 x, s32 y, s32 size, s32 id);
#endif

#ifdef CONFIG_GTP_PROXIMITY
extern u8 gt917s_proximity_flag;
extern int gt917s_prox_event_handler(u8 * data);
#endif

#ifdef CONFIG_GTP_SMART_COVER
extern int gt917s_parse_sc_cfg(int sensor_id);
#endif

#ifdef CONFIG_GTP_ESD_PROTECT
extern void gt917s_init_esd_protect(void);
extern void gt917s_esd_switch(s32 on);
#endif

#ifdef CONFIG_GTP_CHARGER_SWITCH
extern u32 gt917s_get_charger_status(void);
extern void gt917s_charger_switch(s32 on);
extern void gt917s_charger_config(s32 dir_update);
extern int gt917s_parse_chr_cfg(int sensor_id);
#endif
...
#ifdef CONFIG_OF
extern int gt917s_rst_gpio;
extern int gt917s_int_gpio;
#define GTP_RST_PORT                    gt917s_rst_gpio
#define GTP_INT_PORT                    gt917s_int_gpio
#endif
