/* *  x1520_codec.c - Linux kernel modules for audio codec
 *
...
#define X1520_INTERNAL_CODEC_CLOCK 12000000
int jz_codec_init(void)
{
    ...
    codec_dev->codec_clk = X1520_INTERNAL_CODEC_CLOCK;
