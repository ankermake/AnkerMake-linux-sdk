...
static struct cim_sensor_plat_data ov9281_pdata = {
    .name = "sensor-ov9281",
    .pin_pwron = CAMERA_FRONT_SENSOR_PWDN,
    .pin_rst = CAMERA_SENSOR_RESET,
};
#endif
...
#ifdef CONFIG_JZ_VIC_CORE
    {
        I2C_BOARD_INFO("sensor", 0x60),//0x60 for ov9281 misc device
...
#define DEF_GPIO_I2C(NO)                                            \
    ...
    struct platform_device i2c##NO##_gpio_device = {                \
        ...
        .id             = NO,                                       \
        .dev            = {                                         \
            .platform_data = &i2c##NO##_gpio_data,                  \
        },                                                          \
    };
