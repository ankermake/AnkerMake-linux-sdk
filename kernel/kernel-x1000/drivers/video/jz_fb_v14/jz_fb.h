...
#if defined(CONFIG_LCD_V14_TWO_FRAME_BUFFERS)
#define MAX_DESC_NUM 2
#elif defined(CONFIG_LCD_V14_THREE_FRAME_BUFFERS)
...
struct jzfb {
	...
	struct completion frm_msg_complete;
...
#define TIMESTAMP_CAP	16
	...
	int change_xy;
	void *user_vidmem;
	unsigned long user_vidmem_phys;
	unsigned long user_vidmem_size;
	void *fb_mem_mapped;
};
...
#define JZFB_GET_PHY_FRAMEBUF_BASE	_IOWR('F', 0x152, int)
