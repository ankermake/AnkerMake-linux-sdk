...
static inline int __sm5007_read(struct i2c_client *client, u8 reg, uint8_t *val)
{
    int ret;
...
static inline int __sm5007_write(struct i2c_client *client, u8 reg, uint8_t val)
{
    int ret;
...
int sm5007_power_off(void)
{
    ...
    /* Power OFF */
    /* pmu SM5007 power off failed in very few condition, use floader sleep_lib->pmu_poweroff() instead */
