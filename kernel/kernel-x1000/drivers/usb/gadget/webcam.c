...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_yuv_720p = {
	...
	.dwMinBitRate		= cpu_to_le32(552960000),
	.dwMaxBitRate		= cpu_to_le32(5529600000),
...
static const struct UVC_FRAME_UNCOMPRESSED(1) uvc_frame_yuv_1080p = {
    ...
    .dwMinBitRate       = cpu_to_le32(1280 * 1080 * 8 * 10),
    .dwMaxBitRate       = cpu_to_le32(1280 * 1080 * 8 * 10),
    .dwMaxVideoFrameBufferSize  = cpu_to_le32(1280 * 1080),
    .dwDefaultFrameInterval = cpu_to_le32(rate_to_interval(10)),
    .bFrameIntervalType = 1,
    .dwFrameInterval[0] = cpu_to_le32(rate_to_interval(10)),
};
