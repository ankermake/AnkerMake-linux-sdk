...
void halbtc8822c_cfg_wl_rx_gain(struct btc_coexist *btc)
{
    ...
    /* WL Rx Low gain on  */
    static const u32    wl_rx_low_gain_on_HT20[] = {0x00000000};
    static const u32    wl_rx_low_gain_on_HT40[] = {0x00000000};

    /* WL Rx Low gain off  */
    static const u32    wl_rx_low_gain_off_HT20[] = {0x00000000};
    static const u32    wl_rx_low_gain_off_HT40[] = {0x00000000};
    ...
    if (coex_dm->cur_wl_rx_low_gain_en) {
        ...
        for (i = 0; i < ARRAY_SIZE(wl_rx_low_gain_on); i++)
            btc->btc_write_4byte(btc, 0x1d90, wl_rx_low_gain_on[i]);
#endif
        ...
        for (i = 0; i < ARRAY_SIZE(wl_rx_low_gain_off); i++)
            btc->btc_write_4byte(btc, 0x1d90, wl_rx_low_gain_off[i]);
#endif
