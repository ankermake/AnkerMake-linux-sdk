...
static const struct regval_list ov9281_init_regs[] = {
    ...
    {0x3022,0x07},
    {0x3030,0x10},
    {0x3039,0x2e},      /* DVP:enable */
    {0x303a,0xf0},      /* MIPI lane disable */
    ...
    {0x3662,0x07},      /*0x05:RAW10  0x07:RAW8*/
    ...
    {0x3881,0x42},  /* global shutter control */
    {0x3882,0x01},
    {0x3883,0x00},
    {0x3885,0x02},
    {0x389d,0x00},
    ...
    /* Format control */
    {0x4307,0x30},
    {0x4317,0x01},      /* DVP enable: 1-enable */
    ...
    {0x5000,0x9f},
    {0x5001,0x00},
    {0x5e00,0x00},// 0x80:color test pattern
    {0x5d00,0x0b},
    {0x5d01,0x02},
			...
			const struct i2c_device_id *did)
{
	...
	int ret = 0,default_width = 640,default_height=480;
...
MODULE_DESCRIPTION("camera sensor ov9281 driver");
