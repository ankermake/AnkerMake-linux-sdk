...
static int sc2235_g_chip_ident(struct v4l2_subdev *sd, struct v4l2_dbg_chip_ident *chip)
{
    struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static int sc2235_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    if (sc2235_board_info) {
        pwdn_gpio       = sc2235_board_info->gpios.gpio_power;
        reset_gpio      = sc2235_board_info->gpios.gpio_sensor_rst;
        gpio_i2c_sel1   = sc2235_board_info->gpios.gpio_i2c_sel1;
        gpio_i2c_sel2   = sc2235_board_info->gpios.gpio_i2c_sel2;
        sensor_gpio_func= sc2235_board_info->dvp_gpio_func;
    }
#endif
#endif
