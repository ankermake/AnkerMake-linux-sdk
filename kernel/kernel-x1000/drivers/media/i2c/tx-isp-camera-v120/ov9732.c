...
static int ov9732_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    if (ov9732_board_info) {
        pwdn_gpio       = ov9732_board_info->gpios.gpio_power;
        reset_gpio      = ov9732_board_info->gpios.gpio_sensor_rst;
        gpio_i2c_sel1   = ov9732_board_info->gpios.gpio_i2c_sel1;
        gpio_i2c_sel2   = ov9732_board_info->gpios.gpio_i2c_sel2;
        sensor_gpio_func= ov9732_board_info->dvp_gpio_func;
    }
#endif
