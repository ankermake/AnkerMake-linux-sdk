...
#ifndef MODULE
static struct sensor_board_info *imx307_board_info;
#endif
                   ...
                   struct tx_isp_chip_ident *chip)
{
    ...
    if (i2c_sel1_gpio != -1) {
        int ret = gpio_request(i2c_sel1_gpio, "imx307_i2c_sel1");
        if (!ret) {
...
#ifndef MODULE
    imx307_board_info = get_sensor_board_info(imx307_platform_device.name);
    if (imx307_board_info) {
        power_gpio    = imx307_board_info->gpios.gpio_power;
        reset_gpio    = imx307_board_info->gpios.gpio_sensor_rst;
        i2c_sel1_gpio = imx307_board_info->gpios.gpio_i2c_sel1;
    }
#endif
