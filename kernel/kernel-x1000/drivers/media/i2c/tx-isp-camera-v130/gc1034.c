...
static int dvp_gpio_func = DVP_PA_HIGH_10BIT;
...
#ifndef MODULE
static struct sensor_board_info *gc1034_board_info;
#endif
...
static struct camera_reg_op gc1034_init_regs_1280_720[] = {
/*////////////////////////////////////////////////////
//////////////////////   SYS   //////////////////////
////////////////////////////////////////////////////*/
    {CAMERA_REG_OP_DATA,0xf2,0x00},
    {CAMERA_REG_OP_DATA,0xf6,0x00},
    {CAMERA_REG_OP_DATA,0xfc,0x04},
    {CAMERA_REG_OP_DATA,0xf7,0x01},
    {CAMERA_REG_OP_DATA,0xf8,0x0c},
    {CAMERA_REG_OP_DATA,0xf9,0x00},
    {CAMERA_REG_OP_DATA,0xfa,0x80},
    {CAMERA_REG_OP_DATA,0xfc,0x0e},
/*//////////////////////////////////////////////////
//////////////   ANALOG & CISCTL   ////////////////
//////////////////////////////////////////////////*/
    {CAMERA_REG_OP_DATA,0xfe,0x00},
    {CAMERA_REG_OP_DATA,0x03,0x02},
    {CAMERA_REG_OP_DATA,0x04,0xa6},
    {CAMERA_REG_OP_DATA,0x05,0x02}, /*//HB*/
    {CAMERA_REG_OP_DATA,0x06,0x07},
    {CAMERA_REG_OP_DATA,0x07,0x00}, /*//VB*/
    {CAMERA_REG_OP_DATA,0x08,0x0a},
    {CAMERA_REG_OP_DATA,0x09,0x00},
    {CAMERA_REG_OP_DATA,0x0a,0x04}, /*//row start*/
    {CAMERA_REG_OP_DATA,0x0b,0x00},
    {CAMERA_REG_OP_DATA,0x0c,0x00}, /*//col start*/
    {CAMERA_REG_OP_DATA,0x0d,0x02},
    {CAMERA_REG_OP_DATA,0x0e,0xd4}, /*//height 724*/
    {CAMERA_REG_OP_DATA,0x0f,0x05},
    {CAMERA_REG_OP_DATA,0x10,0x08}, /*//width 1288*/
    {CAMERA_REG_OP_DATA,0x17,0xc0},
    {CAMERA_REG_OP_DATA,0x18,0x02},
    {CAMERA_REG_OP_DATA,0x19,0x08},
    {CAMERA_REG_OP_DATA,0x1a,0x18},
    {CAMERA_REG_OP_DATA,0x1e,0x50},
    {CAMERA_REG_OP_DATA,0x1f,0x80},
    {CAMERA_REG_OP_DATA,0x21,0x30},
    {CAMERA_REG_OP_DATA,0x23,0xf8},
    {CAMERA_REG_OP_DATA,0x25,0x10},
    {CAMERA_REG_OP_DATA,0x28,0x20},
    {CAMERA_REG_OP_DATA,0x34,0x08}, /*//data low*/
    {CAMERA_REG_OP_DATA,0x3c,0x10},
    {CAMERA_REG_OP_DATA,0x3d,0x0e},
    {CAMERA_REG_OP_DATA,0xcc,0x8e},
    {CAMERA_REG_OP_DATA,0xcd,0x9a},
    {CAMERA_REG_OP_DATA,0xcf,0x70},
    {CAMERA_REG_OP_DATA,0xd0,0xab},
    {CAMERA_REG_OP_DATA,0xd1,0xc5},
    {CAMERA_REG_OP_DATA,0xd2,0xed}, /*//data high*/
    {CAMERA_REG_OP_DATA,0xd8,0x3c}, /*//dacin offset*/
    {CAMERA_REG_OP_DATA,0xd9,0x7a},
    {CAMERA_REG_OP_DATA,0xda,0x12},
    {CAMERA_REG_OP_DATA,0xdb,0x50},
    {CAMERA_REG_OP_DATA,0xde,0x0c},
    {CAMERA_REG_OP_DATA,0xe3,0x60},
    {CAMERA_REG_OP_DATA,0xe4,0x78},
    {CAMERA_REG_OP_DATA,0xfe,0x01},
    {CAMERA_REG_OP_DATA,0xe3,0x01},
    {CAMERA_REG_OP_DATA,0xe6,0x10}, /*//ramps offset*/
///////////////////////////////////////////////////
////////////////////   ISP   //////////////////////
///////////////////////////////////////////////////
    {CAMERA_REG_OP_DATA,0xfe,0x01},
    {CAMERA_REG_OP_DATA,0x80,0x50},
    {CAMERA_REG_OP_DATA,0x88,0x23},
    {CAMERA_REG_OP_DATA,0x89,0x03},
    {CAMERA_REG_OP_DATA,0x90,0x01},
    {CAMERA_REG_OP_DATA,0x92,0x02}, //crop win 2<=y<=4
    {CAMERA_REG_OP_DATA,0x94,0x03}, //crop win 2<=x<=5
    {CAMERA_REG_OP_DATA,0x95,0x02}, //crop win height
    {CAMERA_REG_OP_DATA,0x96,0xd0},
    {CAMERA_REG_OP_DATA,0x97,0x05}, //crop win width
...
///////////////////////////////////////////////////
    {CAMERA_REG_OP_DATA,0xfe,0x01},
    {CAMERA_REG_OP_DATA,0xb0,0x48},
    {CAMERA_REG_OP_DATA,0xb1,0x01},
    {CAMERA_REG_OP_DATA,0xb2,0x00},
    {CAMERA_REG_OP_DATA,0xb6,0x00},
    {CAMERA_REG_OP_DATA,0xfe,0x02},
    {CAMERA_REG_OP_DATA,0x01,0x00},
    {CAMERA_REG_OP_DATA,0x02,0x01},
    {CAMERA_REG_OP_DATA,0x03,0x02},
    {CAMERA_REG_OP_DATA,0x04,0x03},
    {CAMERA_REG_OP_DATA,0x05,0x04},
    {CAMERA_REG_OP_DATA,0x06,0x05},
    {CAMERA_REG_OP_DATA,0x07,0x06},
    {CAMERA_REG_OP_DATA,0x08,0x0e},
    {CAMERA_REG_OP_DATA,0x09,0x16},
    {CAMERA_REG_OP_DATA,0x0a,0x1e},
    {CAMERA_REG_OP_DATA,0x0b,0x36},
    {CAMERA_REG_OP_DATA,0x0c,0x3e},
    {CAMERA_REG_OP_DATA,0x0d,0x56},
    {CAMERA_REG_OP_DATA,0xfe,0x02},
    {CAMERA_REG_OP_DATA,0xb0,0x00}, //col_gain[11:8]
    {CAMERA_REG_OP_DATA,0xb1,0x00},
    {CAMERA_REG_OP_DATA,0xb2,0x00},
    {CAMERA_REG_OP_DATA,0xb3,0x11},
    {CAMERA_REG_OP_DATA,0xb4,0x22},
    {CAMERA_REG_OP_DATA,0xb5,0x54},
    {CAMERA_REG_OP_DATA,0xb6,0xb8},
    {CAMERA_REG_OP_DATA,0xb7,0x60},
    {CAMERA_REG_OP_DATA,0xb9,0x00}, //col_gain[12]
    {CAMERA_REG_OP_DATA,0xba,0xc0},
    {CAMERA_REG_OP_DATA,0xc0,0x20}, //col_gain[7:0]
    {CAMERA_REG_OP_DATA,0xc1,0x2d},
    {CAMERA_REG_OP_DATA,0xc2,0x40},
    {CAMERA_REG_OP_DATA,0xc3,0x5b},
    {CAMERA_REG_OP_DATA,0xc4,0x80},
    {CAMERA_REG_OP_DATA,0xc5,0xb5},
    {CAMERA_REG_OP_DATA,0xc6,0x00},
    {CAMERA_REG_OP_DATA,0xc7,0x6a},
    {CAMERA_REG_OP_DATA,0xc8,0x00},
    {CAMERA_REG_OP_DATA,0xc9,0xd4},
    {CAMERA_REG_OP_DATA,0xca,0x00},
    {CAMERA_REG_OP_DATA,0xcb,0xa8},
    {CAMERA_REG_OP_DATA,0xcc,0x00},
    {CAMERA_REG_OP_DATA,0xcd,0x50},
    {CAMERA_REG_OP_DATA,0xce,0x00},
    {CAMERA_REG_OP_DATA,0xcf,0xa1},
///////////////////////////////////////////////////
//////////////////   DARKSUN   ////////////////////
///////////////////////////////////////////////////
    {CAMERA_REG_OP_DATA,0xfe,0x02},
    {CAMERA_REG_OP_DATA,0x54,0xf7},
    {CAMERA_REG_OP_DATA,0x55,0xf0},
    {CAMERA_REG_OP_DATA,0x56,0x00},
    {CAMERA_REG_OP_DATA,0x57,0x00},
    {CAMERA_REG_OP_DATA,0x58,0x00},
    {CAMERA_REG_OP_DATA,0x5a,0x04},
///////////////////////////////////////////////////
/////////////////////   DD   //////////////////////
///////////////////////////////////////////////////
    {CAMERA_REG_OP_DATA,0xfe,0x04},
    {CAMERA_REG_OP_DATA,0x81,0x8a},
///////////////////////////////////////////////////
////////////////////     MIPI    /////////////////////
///////////////////////////////////////////////////
    {CAMERA_REG_OP_DATA,0xfe,0x03},
    {CAMERA_REG_OP_DATA,0x01,0x00},
    {CAMERA_REG_OP_DATA,0x02,0x00},
    {CAMERA_REG_OP_DATA,0x03,0x00},
    {CAMERA_REG_OP_DATA,0x10,0x11},
    {CAMERA_REG_OP_DATA,0x15,0x00},
    {CAMERA_REG_OP_DATA,0x40,0x01},
    {CAMERA_REG_OP_DATA,0x41,0x00},
///////////////////////////////////////////////////
////////////////////   pad enable   ///////////////
///////////////////////////////////////////////////
    {CAMERA_REG_OP_DATA,0xfe,0x00},
    {CAMERA_REG_OP_DATA,0xf2,0x0f},
...
static struct camera_reg_op gc1034_stream_on[] = {
    {CAMERA_REG_OP_DATA,0xfe,0x03},
    {CAMERA_REG_OP_DATA,0x10,0x91},
    {CAMERA_REG_OP_DATA,0xfe,0x00},
    {CAMERA_REG_OP_END,0x0,0x0},    /* END MARKER */
};

static struct camera_reg_op gc1034_stream_off[] = {
    {CAMERA_REG_OP_DATA,0xfe,0x03},
    {CAMERA_REG_OP_DATA,0x10,0x81},
    {CAMERA_REG_OP_DATA,0xfe,0x00},
    {CAMERA_REG_OP_END,0x0,0x0},    /* END MARKER */
};

static int gc1034_read(struct tx_isp_subdev *sd, unsigned char reg,
        unsigned char *value)
{
...
static inline int gc1034_read_array(struct tx_isp_subdev *sd, struct camera_reg_op *vals)
{
    int ret;
    unsigned char val;
    while (vals->flag != CAMERA_REG_OP_END) {
        if(vals->flag == CAMERA_REG_OP_DATA) {
            ret = gc1034_read(sd, vals->reg, &val);
            if (ret < 0)
                return ret;
            if (vals->reg == 0xfe){
                val &= 0xf8;
                val |= (vals->val & 0x07);
                ret = gc1034_write(sd, vals->reg, val);
                ret = gc1034_read(sd, vals->reg, &val);
            }
            printk("%x[%x]\n", vals->reg, val);
...
static int gc1034_write_array(struct tx_isp_subdev *sd, struct camera_reg_op *vals)
{
    int ret;
    while (vals->flag != CAMERA_REG_OP_END) {
        if (vals->flag == CAMERA_REG_OP_DATA) {
            ret = gc1034_write(sd, vals->reg, vals->val);
            if (ret < 0)
                return ret;
        } else if (vals->flag == CAMERA_REG_OP_DELAY) {
            private_msleep(vals->val);
...
static int gc1034_set_vflip(struct tx_isp_subdev *sd, int enable)
{
    struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
    int ret = 0;
        ...
        struct tx_isp_chip_ident *chip)
{
    ...
    if(power_gpio != -1){
        ret = gpio_request(power_gpio,"gc1034_power");
    ...
    if (ret) {
        printk("chip found @ 0x%x (%s) is not an gc1034 chip.\n",
                client->addr, client->adapter->name);
        return ret;
    }
    printk("gc1034 chip found @ 0x%02x (%s)\n", client->addr, client->adapter->name);
    if(chip){
...
static int gc1034_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
    ...
    switch(cmd){
        ...
        case TX_ISP_EVENT_SENSOR_AGAIN:
            if(arg)
                ret = gc1034_set_analog_gain(sd, *(u16*)arg);
            break;
        ...
        case TX_ISP_EVENT_SENSOR_VFLIP:
            if(arg)
                ret = gc1034_set_vflip(sd, *(int*)arg);
            break;
        default:
            break;;
    }
...
struct platform_device gc1034_platform_device = {
    .name = "gc1034",
    .id = -1,
    .dev = {
...
static int gc1034_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    pr_debug("probe ok ----start--->gc1034\n");
...
#ifndef MODULE
    gc1034_board_info = get_sensor_board_info(gc1034_platform_device.name);
    if (gc1034_board_info) {
        power_gpio  = gc1034_board_info->gpios.gpio_power;
        pwdn_gpio   = gc1034_board_info->gpios.gpio_sensor_pwdn;
        reset_gpio  = gc1034_board_info->gpios.gpio_sensor_rst;

        dvp_gpio_func = gc1034_board_info->dvp_gpio_func;
    }
#endif
    ...
    gc1034_attr.dvp.gpio = dvp_gpio_func;
     /*
    ...
    tx_isp_subdev_init(&gc1034_platform_device, sd, &gc1034_ops);
...
static __init int init_gc1034(void)
{
    ...
    if(ret){
        printk("Failed to init gc1034 dirver.\n");
        return -1;
    }
