...
#elif defined CONFIG_OV2735_1280X1080
#define OV2735_WIDTH                    1280
#define OV2735_HEIGHT                   1080
#elif defined CONFIG_OV2735_1440X1080
...
static int dvp_gpio_func = DVP_PA_LOW_10BIT;
...
#ifndef MODULE
static struct sensor_board_info *ov2735_board_info;
#endif
...
static inline int ov2735_read_array(struct tx_isp_subdev *sd, struct camera_reg_op *vals)
{
    int ret;
    unsigned char val;
...
#ifndef MODULE
        ov2735_board_info = get_sensor_board_info(ov2735_platform_device.name);
        if (ov2735_board_info) {
            power_gpio    = ov2735_board_info->gpios.gpio_power;
            reset_gpio    = ov2735_board_info->gpios.gpio_sensor_rst;
            i2c_sel1_gpio = ov2735_board_info->gpios.gpio_i2c_sel1;

            dvp_gpio_func = ov2735_board_info->dvp_gpio_func;
        }
#endif
