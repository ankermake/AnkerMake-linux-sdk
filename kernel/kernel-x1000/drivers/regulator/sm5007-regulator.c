...
static struct SM5007_regulator SM5007_regulator[] = {
    ...
    SM5007_REG_BUCK(BUCK2, 0x33, 0, 0x33, 0xFF, 0xFF, 0x00,
            1200, 1200, 0,     0x00, SM5007_ops, 500, sm5703_buck_output_list, 0x46, 0x02, 0x01),
#endif
    SM5007_REG_BUCK(BUCK3, 0x42, 0, 0x42, 0xFF, 0xFF, 0x00,
            1800, 1800, 0,     0x00, SM5007_ops, 500, sm5703_buck_output_list, 0x46, 0x04, 0x02),
    ...
    SM5007_REG_LDO(LDO3, 0x36, 0, 0x36, 0xFF, 0xFF, 0x00,
            3300, 3300, 0, 0x00, SM5007_ops, 500, sm5703_ldo_output_list, 0x43, 0x30, 0x04),
    SM5007_REG_LDO(LDO4, 0x37, 0, 0x37, 0xFF, 0xFF, 0x00,
            2800, 2800, 0, 0x00, SM5007_ops, 500, sm5703_ldo_output_list, 0x43, 0xC0, 0x06),
    SM5007_REG_LDO(LDO5, 0x38, 0, 0x38, 0xFF, 0xFF, 0x00,
            2500, 2500, 0, 0x00, SM5007_ops, 500, sm5703_ldo_output_list, 0x44, 0x03, 0x00),
    SM5007_REG_LDO(LDO6, 0x42, 3, 0x42, 0xFF, 0xFF, 0x00,
            1800, 1800, 0, 0x00, SM5007_ops, 500, sm5703_ldo_output_list, 0x44, 0x0C, 0x02),
    SM5007_REG_LDO(LDO7, 0x42, 4, 0x42, 0x3B, 0x0F, 0x00,
            800,  3300, 0, 0x00, SM5007_ops, 500, sm5703_ldo_output_list, 0x44, 0x30, 0x04),
    SM5007_REG_LDO(LDO8, 0x39, 0, 0x39, 0x3B, 0xF0, 0x04,
            800,  3300, 0, 0x00, SM5007_ops, 500, sm5703_ldo_output_list, 0x44, 0xC0, 0x06),
    SM5007_REG_LDO(LDO9, 0x42, 5, 0x42, 0x3C, 0x0F, 0x00,
            800,  3300, 0, 0x00, SM5007_ops, 500, sm5703_ldo_output_list, 0x45, 0x03, 0x00),
    ...
    SM5007_REG_PS(PS2, 0x3E, 0, 0x3E, 0xFF, 0xFF, 0x00,
            1200, 1200, 0,     0x00, SM5007_ops, 500, sm5703_buck_output_list, 0x00, 0x00, 0x00),
    SM5007_REG_PS(PS3, 0x3F, 0, 0x3F, 0xFF, 0xFF, 0x00,
            1800, 1800, 0,     0x00, SM5007_ops, 500, sm5703_buck_output_list, 0x00, 0x00, 0x00),
    SM5007_REG_PS(PS4, 0x40, 0, 0x40, 0xFF, 0xFF, 0x00,
            3000, 3000, 0,     0x00, SM5007_ops, 500, sm5703_ldo_output_list,  0x00, 0x00, 0x00),
    SM5007_REG_PS(PS5, 0x41, 0, 0x41, 0xFF, 0xFF, 0x00,
            2800, 2800, 0,     0x00, SM5007_ops, 500, sm5703_ldo_output_list,  0x00, 0x00, 0x00),
};
...
{
    int ret = 0;
    struct regulator_dev *rdev = dev_get_drvdata(ri->dev);
    ...
    if (SM5007_pdata->init_enable) {
        ret = SM5007_reg_enable(rdev);
    } else {
        ret = SM5007_reg_disable(rdev);
    }
    if (ret < 0)
...
static int SM5007_regulator_probe(struct platform_device *pdev)
{
    ...
    sm5007_set_bits(pdev->dev.parent, SM5007_CNTL1 , 0x20); //manual reset: Enable.default long press 7S.
...
//postcore_initcall(SM5007_regulator_init); // branch Indroid5.1-master
