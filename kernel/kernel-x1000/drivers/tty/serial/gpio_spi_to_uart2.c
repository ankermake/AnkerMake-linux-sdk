...
#define SPI_TO_UART_NAME2    "jz_spi_to_uart2"
#define SPI_TO_UART_MAX_DEVS    8

#define UART_BAUD_RATE  (115200)

#define SPI_GPIO_CS CONFIG_SERIAL_GPIO_SPI_TO_UART2_CS_PIN
#define SPI_GPIO_DT CONFIG_SERIAL_GPIO_SPI_TO_UART2_DT_PIN
#define SPI_GPIO_DR CONFIG_SERIAL_GPIO_SPI_TO_UART2_DR_PIN
#define SPI_GPIO_CLK CONFIG_SERIAL_GPIO_SPI_TO_UART2_CLK_PIN
...
static int tx_rx_byte(unsigned int t)
{
    int i;
    int v = 0;
...
unsigned char send_check(unsigned char cmd, unsigned char data)
{
...
static int __init gpio_spi_to_uart_init2(void)
{
    int ret;
...
module_init(gpio_spi_to_uart_init2);

static void __exit gpio_spi_to_uart_exit2(void)
{
    uart_unregister_driver(&spi_to_uart_drv);
}
module_exit(gpio_spi_to_uart_exit2);
