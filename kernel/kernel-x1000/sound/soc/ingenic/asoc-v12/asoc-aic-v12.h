...
#if defined(CONFIG_SOC_X1830)
#define __i2s_bclk_output(parent) \
	do { \
		jz_aic_set_reg(parent, AICFR, 1, AICFR_BCKD_MASK, AICFR_BCKD_BIT); \
		jz_aic_set_reg(parent, AICFR, 1, AICFR_IBCKD_MASK, AICFR_IBCKD_BIT); \
		pr_err("__i2s_bclk_output()\n"); \
	} while (0)
#define __i2s_bclk_input(parent) \
	do { \
		jz_aic_set_reg(parent, AICFR, 0, AICFR_BCKD_MASK, AICFR_BCKD_BIT); \
		jz_aic_set_reg(parent, AICFR, 0, AICFR_IBCKD_MASK, AICFR_IBCKD_BIT); \
		pr_err("__i2s_bclk_input()\n"); \
	} while (0)
#define __i2s_sync_output(parent) \
	do { \
		jz_aic_set_reg(parent, AICFR, 1, AICFR_SYNCD_MASK, AICFR_SYNCD_BIT); \
		jz_aic_set_reg(parent, AICFR, 1, AICFR_ISYNCD_MASK, AICFR_ISYNCD_BIT); \
		pr_err("__i2s_sync_output()\n"); \
	} while (0)
#define __i2s_sync_input(parent) \
	do { \
		jz_aic_set_reg(parent, AICFR, 0, AICFR_SYNCD_MASK, AICFR_SYNCD_BIT); \
		jz_aic_set_reg(parent, AICFR, 0, AICFR_ISYNCD_MASK, AICFR_ISYNCD_BIT); \
		pr_err("__i2s_sync_input()\n"); \
	} while (0)
#else
#define __i2s_bclk_output(parent)            \
	jz_aic_set_reg(parent, AICFR, 1, AICFR_BCKD_MASK, AICFR_BCKD_BIT)
