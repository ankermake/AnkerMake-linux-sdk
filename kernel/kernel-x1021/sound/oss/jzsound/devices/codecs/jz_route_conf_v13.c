...
/* This route is for acoustic echo cancellation(AEC) */
route_conf_base const replay_sound_and_record_mixer_stereo_loopback = {
	.route_ready_mode = ROUTE_READY_FOR_DAC,

	.route_replay_mixer_mode = REPLAY_MIXER_NORMAL_INPUT,
	.route_record_mixer_mode = RECORD_MIXER_L_0_R_0_INPUT,
...
route_conf_base const replay_sound_and_record_mixer_mono_loopback = {
	.route_ready_mode = ROUTE_READY_FOR_DAC,
...
struct __codec_route_info codec_route_info[] = {
	...
	/*********************** misc route *******************************/
	{
		.route_name = SND_ROUTE_REPLAY_SOUND_MIXER_STEREO_LOOPBACK,
		.route_conf = &replay_sound_and_record_mixer_stereo_loopback,
	},
	{
	...
	},
	{
		...
		.route_conf = &replay_sound_and_record_mixer_mono_loopback,
	},
	{
