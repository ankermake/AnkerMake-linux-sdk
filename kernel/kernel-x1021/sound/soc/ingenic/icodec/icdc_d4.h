...
struct icdc_d4 {
	...
	int power_on;
        int dac_enabled;
        int adc_enabled;
        int micbias_jiffies_vaild;
        int micbias_enable;
        int audio_source;
	int alc_mode;
        int micbias_time_val;
};
...
#define ICDC_CASR_DACLECHSRC(x)         (((x) << ICDC_CASR_DACLECHSRC_SFT) & ICDC_CASR_DACLECHSRC_MSK)
...
#define ICDC_CCR_DACCHAGESEL_MSK        (0x7f << ICDC_CCR_DACCHAGESEL_SFT)
