...
#if defined(CONFIG_SERIAL_JZ47XX_UART0_PB_NOCTSRTS)
	UART0_PORTB_NOCTSRTS,
#elif defined(CONFIG_SERIAL_JZ47XX_UART0_FULL_DUPLEX)
	UART0_PORTB_FULL_DUPLEX,
#else
	UART0_PORTB_FULL_DUPLEX,
#endif
#endif
...
#if defined(CONFIG_SERIAL_JZ47XX_UART2_PC_NOCTSRTS_PC0809)
	UART2_PORTC_PC0809,
#elif defined(CONFIG_SERIAL_JZ47XX_UART2_PC_NOCTSRTS_PC1314)
	UART2_PORTC_PC1314,
#elif defined(CONFIG_SERIAL_JZ47XX_UART2_PC_NOCTSRTS_PC1718)
	UART2_PORTC_PC1718,
#elif defined(CONFIG_SERIAL_JZ47XX_UART2_PC_FULL_DUPLEX)
	UART2_PORTC_FULL_DUPLEX,
#else
	UART2_PORTC_PC0809,
#endif
#endif
...
#if defined(CONFIG_JZ_SPI0_PIO_CE_ONLY)
	SSI0_PORTC_CE_ONLY,
#elif defined(CONFIG_JZ_SPI0_ONLY_DT_CLK)
	SSI0_PORTC_ONLY_DT_CLK,
#elif defined(CONFIG_JZ_SPI_PIO_CE)
	SSI0_PORTC_NO_CE,
#else
	SSI0_PORTC,
#endif
...
#if defined(CONFIG_JZ_SPI1_PIO_CE_ONLY)
	SSI1_PORTB_CE_ONLY,
#elif defined(CONFIG_JZ_SPI1_ONLY_DT_CLK)
	SSI1_PORTB_ONLY_DT_CLK,
#elif defined(CONFIG_JZ_SPI_PIO_CE)
	SSI1_PORTB_NO_CE,
#else
	SSI1_PORTB,
...
#if defined(CONFIG_JZ_MAC) && !defined(CONFIG_JZ_INTERNAL_MAC_PHY)
	GMAC_PORTB,
#endif
...
/* FB */
#if defined(CONFIG_FB_JZ_V14) || defined(CONFIG_FB_JZ_X1021)
