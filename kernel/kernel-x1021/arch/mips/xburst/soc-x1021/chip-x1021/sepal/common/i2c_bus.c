...
static struct cim_sensor_plat_data vic_sensor_pdata = {
    .name = VIC_SENSOR_NAME,
    .pin_i2c_sel1 = PIN_VIC_I2C_SEL1,
    .pin_i2c_sel2 = PIN_VIC_I2C_SEL2,
    .pin_pwron = PIN_VIC_PWR_ON,
    .pin_rst = PIN_VIC_RST,
};
#endif
...
struct i2c_board_info jz_i2c0_devs[] __initdata = {
    {
        I2C_BOARD_INFO("sensor", SENSOR_DEV_ID),//7bit device id for sensor
        .platform_data  = &vic_sensor_pdata,
    },
};
#endif
