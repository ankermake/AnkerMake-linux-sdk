...
#endif
#ifdef CONFIG_FB_JZ_X1021
	DEF_DEVICE(&jz_fb_device,&jzfb_pdata,sizeof(jzfb_pdata)),
#endif
...
DEF_DEVICE(&jz_isp_device, NULL, 0),
#endif
...
static int __init board_base_init(void)
{
	...
	spi_register_board_info(jz_spi_board_info, jz_spi_devs_size);
#endif
