...
#define BACK_CAMERA_LINK(NO)							\
static struct soc_camera_link iclink_back = {					\
	.bus_id		= 0,							\
	.board_info	= &jz_i2c##NO##_camera_devs[BACK_CAMERA_INDEX],		\
	.i2c_adapter_id	= NO,							\
	.power = back_camera_sensor_power,					\
	.reset = back_camera_sensor_reset,					\
};

#if defined(BACK_CAMERA_I2C_0)
BACK_CAMERA_LINK(0);
#endif
#if defined(BACK_CAMERA_I2C_1)
BACK_CAMERA_LINK(1);
#endif
...
#define FRONT_CAMERA_LINK(NO)							\
static struct soc_camera_link iclink_front = {					\
	.bus_id		= 1,							\
	.board_info	= &jz_i2c##NO##_camera_devs[FRONT_CAMERA_INDEX],	\
	.i2c_adapter_id	= NO,							\
	.power = front_camera_sensor_power,					\
	.reset = front_camera_sensor_reset,					\
};

#if defined(FRONT_CAMERA_I2C_0)
FRONT_CAMERA_LINK(0);
#endif
#if defined(FRONT_CAMERA_I2C_1)
FRONT_CAMERA_LINK(1);
#endif
