...
int startek_kd050hdfia020_init(struct lcd_device *lcd)
{
    int ret = 0;
...
int startek_kd050hdfia020_reset(struct lcd_device *lcd)
{
...
int startek_kd050hdfia020_power_on(struct lcd_device *lcd, int enable)
{
    if(startek_kd050hdfia020_init(lcd))
        return -EFAULT;
    gpio_direction_output(GPIO_MIPI_PWR, enable); /* 2.8v en */
    msleep(2);
    return 0;
}
struct lcd_platform_data startek_kd050hdfia020_data = {
	.reset = startek_kd050hdfia020_reset,
	.power_on= startek_kd050hdfia020_power_on,
};

struct mipi_dsim_lcd_device startek_kd050hdfia020_device={
	.name		= "startek_kd050hdfia020-lcd",
	.id = 0,
	.platform_data = &startek_kd050hdfia020_data,
};
