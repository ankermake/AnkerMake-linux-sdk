...
static struct snd_board_gpio power_pin = {
	.gpio = GPIO_EXTCODEC_POWER,
	.active_level = GPIO_EXTCODEC_POWER_LEVEL,
};
static struct snd_board_gpio reset_pin = {
	.gpio = GPIO_EXTCODEC_RESET,
	.active_level = GPIO_EXTCODEC_RESET_LEVEL,
};
static struct snd_board_gpio mute_pin = {
	.gpio = GPIO_EXTCODEC_MUTE,
	.active_level = GPIO_EXTCODEC_MUTE_LEVEL,
};
static struct extcodec_platform_data npcp215_data = {
	.power = &power_pin,
	.reset = &reset_pin,
	.mute = &mute_pin,
};
...
#ifdef CONFIG_SND_ASOC_INGENIC_EXTCODEC_NPCP215
	{
		I2C_BOARD_INFO("npcp215",0x73),
		.platform_data = &npcp215_data,
	},
#endif
};
