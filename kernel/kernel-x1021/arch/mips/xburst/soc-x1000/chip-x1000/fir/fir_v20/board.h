...
#define GPIO_USB_ID_LEVEL       HIGH_ENABLE
...
#define GPIO_USB_DRVVBUS_LEVEL      LOW_ENABLE
/* ****************************GPIO USB END********************************** */
...
#else
#define GPIO_SPEAKER_EN    GPIO_PB(25)         /*speaker enable gpio*/
...
#define BATTERY_CHARGE_STATUS	GPIO_PB(19)
#define BATTERY_CHARGE_FUNC	GPIO_INPUT
#define BATTERY_ISET_PIN	-1/*GPIO_PB(8)*/
...
#define GPIO_LCD_RST    GPIO_PB(5)
#define GPIO_BL_PWR_EN  -1
#define GPIO_LCD_PWM    GPIO_PB(4)
#define GPIO_LCD_VDD_EN GPIO_PB(16)
#endif


/* TOUCHSCREEN */
#define GPIO_TP_INT     GPIO_PB(3)
#define GPIO_TP_RESET     GPIO_PB(2)
#define GPIO_TP_EN    -1
