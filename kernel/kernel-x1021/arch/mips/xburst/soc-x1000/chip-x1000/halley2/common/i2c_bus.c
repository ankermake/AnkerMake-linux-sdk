...
#if (defined(CONFIG_SOFT_I2C1_GPIO_V12_JZ) || defined(CONFIG_I2C1_V12_JZ) || defined(CONFIG_I2C1_MCU_JZ))
...
#ifdef CONFIG_I2C_MCU_JZ
static u64 jz_i2c_dmamask =  ~(u32)0;
#define DEF_I2C(NO)							\
    static struct i2c_gpio_platform_data jz_i2c##NO##_data = {    \
        .sda_pin    = GPIO_I2C##NO##_SDA,           \
        .scl_pin    = GPIO_I2C##NO##_SCK,           \
     };                              \
