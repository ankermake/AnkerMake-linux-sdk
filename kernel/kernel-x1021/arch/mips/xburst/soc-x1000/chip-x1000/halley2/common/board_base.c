...
/* JZ ALSA audio driver */
    ...
    DEF_DEVICE(&jz_aic_dma_device, &aic_dma_data, sizeof(struct snd_dma_data)),
#endif
	...
	DEF_DEVICE(&jz_pcm_dma_device, &pcm_dma_data,sizeof(struct snd_dma_data)),
#endif

#if defined(CONFIG_SND_ASOC_JZ_DMIC_V13)
    DEF_DEVICE(&jz_dmic_device,0,0),
	DEF_DEVICE(&jz_dmic_dma_device, &dmic_dma_data, sizeof(struct snd_dma_data)),
#endif
...
/* end of ALSA audio driver */
...
#ifdef CONFIG_SOUND_JZ_DMIC_V13
...
#ifdef  CONFIG_LCD_NHD_160128UGC3
	DEF_DEVICE(&nhd_160128ugc_device, 0, 0),
#endif
...
#ifdef CONFIG_XBURST_PDMA_MCU
	DEF_DEVICE(&jz_mcu_device, 0, 0),
#endif
	...
	DEF_DEVICE(&factory_test_device, 0, 0),
#endif
#ifdef	CONFIG_JZ_SFC
...
#ifdef	CONFIG_I2C0_MCU_JZ
	DEF_DEVICE(&jz_i2c0_device,0,0),
#endif
#ifdef	CONFIG_I2C1_MCU_JZ
	DEF_DEVICE(&jz_i2c1_device,0,0),
#endif
#ifdef	CONFIG_I2C2_MCU_JZ
	DEF_DEVICE(&jz_i2c2_device,0,0),
#endif
...
#endif
#ifdef CONFIG_LEDS_PWM
extern void pwm_table_init(void);
#endif
...
#if (defined(CONFIG_SOFT_I2C2_GPIO_V12_JZ) || defined(CONFIG_I2C2_V12_JZ) || defined(CONFIG_I2C2_MCU_JZ))
     i2c_register_board_info(2, jz_i2c2_devs, jz_i2c2_devs_size);
#endif

#if (defined(CONFIG_SOFT_I2C0_GPIO_V12_JZ) || defined(CONFIG_I2C0_V12_JZ) || defined(CONFIG_I2C0_MCU_JZ))
