...
#define GPIO_BT_REG_ON          GPIO_PB(2)
#define GPIO_BT_WAKE            GPIO_PB(01)
#define GPIO_BT_INT             GPIO_PB(0)
#define GPIO_BT_UART_RTS        GPIO_PB(3)
#endif

#ifdef CONFIG_BCMDHD_1_141_66
#define GPIO_WIFI_RST_N		-1//GPIO_PC(17)
#define GPIO_WIFI_WAKE 		-1//GPIO_PC(16)
#endif
...
#define GPIO_SPEAKER_EN    GPIO_PD(2)   /*speaker enable gpio*/
#define GPIO_SPEAKER_EN_LEVEL   1

#define GPIO_AMP_POWER_EN	-1	/* amp power enable pin */
#define GPIO_AMP_POWER_EN_LEVEL 0
