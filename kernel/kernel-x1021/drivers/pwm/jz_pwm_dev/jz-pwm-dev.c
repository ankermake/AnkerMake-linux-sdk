...
static int jz_pwm_dev_enable(struct jz_pwm_classdev *cdev)
{
...
static int jz_pwm_dev_get(struct jz_pwm_classdev *cdev)
{
	struct jz_pwm_dev_data *dev_dat =
		container_of(cdev, struct jz_pwm_dev_data, cdev);
...
static void jz_pwm_dev_set(struct jz_pwm_classdev *cdev,int val,int flag)
{
	struct jz_pwm_dev_data *dev_dat =
		container_of(cdev, struct jz_pwm_dev_data, cdev);
	unsigned int max = dev_dat->cdev.max_duty_ratio;
