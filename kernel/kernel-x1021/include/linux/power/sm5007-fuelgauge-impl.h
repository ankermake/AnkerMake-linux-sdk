...
#define SM5007_REG_IOCV_MAN         0x2E
...
#define ENABLE_IOCV_MAN_MODE    0x0200
...
#elif defined(CONFIG_475MAH_BATTERY)
int battery_table_para[][16] =
    {
        {0x1400, 0x1D7A, 0x1D8B, 0x1DB9, 0x1DE7, 0x1E2F, 0x1E72, 0x1EBE, 0x1F0E, 0x1F9C, 0x2004, 0x208C, 0x20A8, 0x21D7, 0x22AE, 0x2399},
        {0x1400, 0x1D7A, 0x1D8B, 0x1DB9, 0x1DE7, 0x1E2F, 0x1E72, 0x1EBE, 0x1F0E, 0x1F9C, 0x2004, 0x208C, 0x20A8, 0x21D7, 0x22AE, 0x2399},
        {0x000, 0x004, 0x030, 0x061, 0x091, 0x0F3, 0x154, 0x1B5, 0x1FE, 0x247, 0x290, 0x2C1, 0x2D9, 0x36B, 0x3CC, 0x3d5}
    };

#elif defined(CONFIG_450MAH_BATTERY)
int battery_table_para[][16] =
    {
        {0x1400, 0x1D5C, 0x1D77, 0x1D83, 0x1DD8, 0x1DFE, 0x1E22, 0x1E5F, 0x1EB0, 0x1EE9, 0x1F1D, 0x1F9B, 0x2023, 0x20CB, 0x2187, 0x2266},
        {0x1400, 0x1D5C, 0x1D77, 0x1D83, 0x1DD8, 0x1DFE, 0x1E22, 0x1E5F, 0x1EB0, 0x1EE9, 0x1F1D, 0x1F9B, 0x2023, 0x20CB, 0x2187, 0x2266},
        {0x000, 0x004, 0x020, 0x045, 0x08A, 0x0B8, 0x0E6, 0x170, 0x1E3, 0x211, 0x228, 0x285, 0x2E1, 0x33D, 0x399, 0x39E}
    };
#else
#error "select your battery table, or add a new one !"
#endif
