...
extern struct axp_supply_init_data axp216_sply_init_data;
...
static int axp_battery_probe(struct platform_device *pdev)
{
    ...
    pdata = &axp216_sply_init_data;

#if 0
    printk(KERN_ERR "chgcur %d\n", pdata->chgcur);
    printk(KERN_ERR "chgvol %d\n", pdata->chgvol);
    printk(KERN_ERR "chgend %d\n", pdata->chgend);
    printk(KERN_ERR "sample_time %d\n", pdata->sample_time);
    printk(KERN_ERR "chgen %d\n", pdata->chgen);
    printk(KERN_ERR "chgpretime %d\n", pdata->chgpretime);
    printk(KERN_ERR "chgcsttime %d\n", pdata->chgcsttime);
    printk(KERN_ERR "battery_info %s\n", pdata->battery_info->name);
#endif
