...
#define SC2310_SUPPORT_SCLK             (152000000)
 ...
 * dvdd=1.500000
 */
static struct regval_list sc2310_init_regs_1920_1080_60fps_mipi[] = {
    {0x0103,0x01},
    {0x0100,0x00},
    ...
    {0x320b,0x38},
    {0x320c,0x04},
    {0x320d,0x76}, /*hts 1142*2 */
    {0x320e,0x04},
    {0x320f,0x55}, /* vts 1109 */
    {0x3211,0x04},
    {0x3213,0x04},
    {0x3222,0x29},
    {0x3235,0x08},
...
static struct sensor_attr sc2310_sensor_attr = {
    ...
    .sensor_info = {
        .private_init_setting   = sc2310_init_regs_1920_1080_60fps_mipi,
#ifndef SC2310_BINNING_MODE
        .width                  = SC2310_WIDTH,
        .height                 = SC2310_HEIGHT,
#else
        .width                  = SC2310_WIDTH/2,
        .height                 = SC2310_HEIGHT/2,
#endif
        .fmt                    = SENSOR_PIXEL_FMT_SBGGR10_1X10,

        .fps                    = 60 << 16 | 1,
        .total_width            = 0x0476*2,
        .total_height           = 0x0455,

        .min_integration_time   = 3,
        .max_integration_time   = 0x0455 - 3,
