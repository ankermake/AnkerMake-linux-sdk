...
#define WIFI_PLAT_NAME		"md_bcmdhd_wlan"
...
static int wifi_plat_dev_drv_probe(struct platform_device *pdev)
{
	...
	/* Android style wifi platform data device ("md_bcmdhd_wlan" or "bcm4329_wlan")
	...
	resource = platform_get_resource_byname(pdev, IORESOURCE_IRQ, "md_bcmdhd_wlan_irq");
	if (resource == NULL)
...
static const struct of_device_id wifi_device_dt_match[] = {
	{ .compatible = "android,md_bcmdhd_wlan", },
	{},
};
#endif /* CONFIG_DTS */
