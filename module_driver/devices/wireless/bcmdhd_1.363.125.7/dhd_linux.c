...
#ifndef MD_DHD_SET_RANDOM_MAC_VAL
#define MD_DHD_SET_RANDOM_MAC_VAL	0x001A11
#endif
static u32 vendor_oui = MD_DHD_SET_RANDOM_MAC_VAL;
...
bool dhd_update_fw_nv_path(dhd_info_t *dhdinfo)
{
	...
	if (!dhd_download_fw_on_driverload) {
#ifdef MD_BCMDHD_1_363_125_7_FW_PATH
		fw = MD_BCMDHD_1_363_125_7_FW_PATH;
#endif /* MD_BCMDHD_1_363_125_7_FW_PATH */
#ifdef MD_BCMDHD_1_363_125_7_NVRAM_PATH
		nv = MD_BCMDHD_1_363_125_7_NVRAM_PATH;
#endif /* MD_BCMDHD_1_363_125_7_NVRAM_PATH */
	}
...
dhd_free(dhd_pub_t *dhdp)
{
	...
	if (dhdp) {
		...
		dhd = (dhd_info_t *)dhdp->info;
		if (dhdp->soc_ram) {
#if defined(MD_DHD_USE_STATIC_BUF) && defined(DHD_USE_STATIC_MEMDUMP)
			DHD_OS_PREFREE(dhdp, dhdp->soc_ram, dhdp->soc_ram_length);
#else
			MFREE(dhdp->osh, dhdp->soc_ram, dhdp->soc_ram_length);
#endif /* MD_DHD_USE_STATIC_BUF && DHD_USE_STATIC_MEMDUMP */
			dhdp->soc_ram = NULL;
		}
