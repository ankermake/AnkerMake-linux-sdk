...
static int rtl8723_driver_init(void)
{
    int ret = 0;
...
static void rtl8723_driver_deinit(void)
{
...
static void rtl8723_driver_exit(void)
{
    platform_driver_unregister(&rtl8723ds_driver);
}
#else
