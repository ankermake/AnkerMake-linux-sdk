...
#define bcm_del_timer(t) del_timer(t)
#define bcm_del_timer_sync(t) del_timer_sync(t)
...
#define bcm_del_timer(t) del_timer(&((t)->timer))
#define bcm_del_timer_sync(t) del_timer_sync(&((t)->timer))
...
/* 2.4.x introduced bcm_del_timer_sync() */
#define bcm_del_timer_sync(timer) bcm_del_timer(timer)
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 0)) && (LINUX_VERSION_CODE < KERNEL_VERSION(5, 1, 0))
