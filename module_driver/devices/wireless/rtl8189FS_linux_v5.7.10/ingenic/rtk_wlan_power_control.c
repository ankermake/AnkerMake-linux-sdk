...
{
	struct wake_lock	*wifi_wake_lock = &rtl_8189_data.wifi_wake_lock;
...
static int rtk_wlan_deinit(void)
{
	struct wake_lock	*wifi_wake_lock = &rtl_8189_data.wifi_wake_lock;
...
{
	static struct wake_lock	*wifi_wake_lock = &rtl_8189_data.wifi_wake_lock;
