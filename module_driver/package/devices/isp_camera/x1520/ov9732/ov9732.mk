...
package_module_src = devices/isp_camera/x1520/ov9732
package_make_hook =
package_init_hook =
...
define sensor_ov9732_install_hook
	...
	$(Q)cp -rf package/devices/isp_camera/x1520/ov9732/ov9732.bin  $(FS_TARGET_DIR)/etc/sensor/
endef
...
define sensor_ov9732_finalize_hook
	$(Q)cp devices/isp_camera/x1520/ov9732/sensor_ov9732.ko output/
	...
	$(Q)echo -n ' dvp_gpio_func_str=$(MD_X1520_OV9732_DVP_GPIO_FUNC)' >> $(sensor_ov9732_init_file)
