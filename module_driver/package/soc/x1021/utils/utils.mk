...
package_module_src = soc/x1021/utils
package_make_hook =
package_init_hook =
...
define soc_utils_finalize_hook
	$(Q)cp soc/x1021/utils/soc_utils.ko output/
	$(Q)echo -n 'insmod soc_utils.ko ' > $(soc_utils_init_file)

	$(if $(MD_X1021_UTILS_RTC32K), $(Q)echo -n ' rtc32k_init_on=$(if $(MD_X1021_UTILS_RTC32K_INIT_ON),1,0) ' >> $(soc_utils_init_file))
