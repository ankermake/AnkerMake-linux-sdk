...
typedef struct Tiziano_Isp_Ae_Wmean_Param {
	...
	int *a_ae_array_sc;
	int *a_ae_parameter;
	int *a_ae_zone_weight;
	int *a_exp_parameter;
	int *a_ae_stat;
	int *a_scene_roui_weight;
	int *a_scene_roi_weight;
	int *a_log2_lut;
	int *a_weight_lut;
...
int tisp_core_init(tisp_core_t *core, tisp_init_param_t *p, void *priv_data, void *data);
