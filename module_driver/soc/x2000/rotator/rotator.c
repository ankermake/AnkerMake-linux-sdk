...
static inline void *rotator_m_dma_alloc_coherent(int size)
{
...
static inline void rotator_m_dma_free_coherent(void *mem, int size)
{
...
static void rotator_init_desc(struct frame_descriptor *desc, struct rotator_config_data *config)
{
    ...
    dma_cache_sync(NULL, desc, sizeof(struct frame_descriptor), DMA_TO_DEVICE);
}
...
static int __init jz_rotator_init(void)
{
    ...
    rotator_dev.desc = rotator_m_dma_alloc_coherent(sizeof(struct frame_descriptor));
...
{
    rotator_m_dma_free_coherent(rotator_dev.desc, sizeof(struct frame_descriptor));
