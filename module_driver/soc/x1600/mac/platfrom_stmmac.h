...
struct stmmac_virtual_phy {
	int (*read)(void *priv, int phy_id, int regnum);
	int (*write)(void *priv, int phy_id, int regnum, u16 val);
};
...
struct stmmac_mdio_bus_data {
	...
	int *irqs;
	int probed_phy_irq;
	struct stmmac_virtual_phy *virtual_phy;
};
