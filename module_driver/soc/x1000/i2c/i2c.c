...
static struct jz_i2c_pin jz_i2c0_pin[1] = {
    {
        .sda        = {GPIO_PB(24),  GPIO_FUNC_0},
        .scl        = {GPIO_PB(23),  GPIO_FUNC_0},
    },
};

static struct jz_i2c_pin jz_i2c1_pin[2] = {
    {
        .sda        = {GPIO_PA(1),  GPIO_FUNC_2},
        .scl        = {GPIO_PA(0),  GPIO_FUNC_2},
    },
    {
        .sda        = {GPIO_PC(27),  GPIO_FUNC_0},
        .scl        = {GPIO_PC(26),  GPIO_FUNC_0},
    },
};

static struct jz_i2c_pin jz_i2c2_pin[1] = {
    {
        .sda        = {GPIO_PD(1),  GPIO_FUNC_1},
        .scl        = {GPIO_PD(0),  GPIO_FUNC_1},
    },
};
 ...
 */
static struct jz_i2c_drv jz_i2c_dev[3] = {
    {
        .id         = 0,
        .irq        = IRQ_I2C0,
        .irq_name   = "I2C0",
...
static void jz_i2c_init_setting(struct jz_i2c_drv *drv)
{
    ...
    struct clk *clk_apb = clk_get(NULL, "apb0");
...
static int jz_i2c_init(int id)
{
    ...
    ret = request_irq(drv->irq, i2c_intr_handler, IRQF_DISABLED, drv->irq_name , drv);
    if (ret < 0) {
...
MODULE_DESCRIPTION("X1000 SoC I2C driver");
MODULE_LICENSE("GPL");
