...
struct jz_spi_drv *jzspi_handle;

static struct jz_spi_pin jz_spi0_pin[2] = {
    {
        {
            {GPIO_PA(31), GPIO_FUNC_0, "spi0_clk"},
            {GPIO_PA(29), GPIO_FUNC_0, "spi0_miso"},
            {GPIO_PA(30), GPIO_FUNC_0, "spi0_mosi"},
        },
    },

    {
        {
            {GPIO_PB(12), GPIO_FUNC_1, "spi0_clk"},
            {GPIO_PB(14), GPIO_FUNC_1, "spi0_miso"},
            {GPIO_PB(13), GPIO_FUNC_1, "spi0_mosi"},
        },
    },
};
...
{
    struct jz_spi_drv *hw = jzspi_handle;
