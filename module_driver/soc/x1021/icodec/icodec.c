...
#define ICODEC_RATE (SNDRV_PCM_RATE_44100 | SNDRV_PCM_RATE_48000 | SNDRV_PCM_RATE_96000)
...
static int spkeaker_gpio_request(void)
{
    ...
    if (spk_gpio >= 0) {
        ...
        gpio_direction_output(spk_gpio, DISABLE);
    }
