...
#define MAC_CRLT_FUNC               GPIO_FUNC_0
...
static int jz_mac_init(struct platform_device *pdev, void *priv)
{
    ...
    gpio_port_set_func(MAC_CRLT_PORT, MAC_CRLT_GPIO_MASK, MAC_CRLT_FUNC | GPIO_PULL_HIZ);
