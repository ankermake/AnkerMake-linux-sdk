...
static struct jz_spi_pin jz_spi0_pin[1] = {
    {
        {
            {GPIO_PC(13), GPIO_FUNC_0, "spi0_clk"},
...
static struct jz_spi_pin jz_spi1_pin[1] = {
    {
        {
            {GPIO_PB(10), GPIO_FUNC_1, "spi1_clk"},
            {GPIO_PB(9), GPIO_FUNC_1, "spi1_miso"},
            {GPIO_PB(8), GPIO_FUNC_1, "spi1_mosi"},
        },
    },
};
