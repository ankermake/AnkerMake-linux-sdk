...
int dmic_dma_pcm_open(struct snd_soc_component *component,
		    struct snd_pcm_substream *substream)
{
    ...
    dmic_dma->dma_desc = m_dma_alloc_coherent(component->dev, sizeof(*dmic_dma->dma_desc));
...
int dmic_dma_pcm_close(struct snd_soc_component *component,
		     struct snd_pcm_substream *substream)
{
    struct snd_pcm_runtime *runtime = substream->runtime;
    struct dmic_dma_data *dmic_dma = runtime->private_data;

    m_dma_free_coherent(component->dev, dmic_dma->dma_desc, sizeof(*dmic_dma->dma_desc));
...
int dmic_dma_pcm_hw_params(struct snd_soc_component *component,
			 struct snd_pcm_substream *substream,
...
int dmic_dma_pcm_hw_free(struct snd_soc_component *component,
		       struct snd_pcm_substream *substream)
{
    struct snd_pcm_runtime *runtime = substream->runtime;
    struct dmic_dma_data *dmic_dma = runtime->private_data;
...
int dmic_dma_pcm_trigger(struct snd_soc_component *component,
...
snd_pcm_uframes_t dmic_dma_pcm_pointer(struct snd_soc_component *component,
				     struct snd_pcm_substream *substream)
{
    struct snd_pcm_runtime *runtime = substream->runtime;
    struct dmic_dma_data *dmic_dma = runtime->private_data;
...
int dmic_dma_pcm_prepare(struct snd_soc_component *component,
		       struct snd_pcm_substream *substream)
{
    return 0;
}

int dmic_dma_pcm_new(struct snd_soc_component *component,
...
void dmic_dma_pcm_free(struct snd_soc_component *component,
			     struct snd_pcm *pcm)
{
