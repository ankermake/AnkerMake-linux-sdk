			   ...
			   struct snd_pcm_substream *substream)
{
    ...
    spdif_dma->dma_desc = m_dma_alloc_coherent(component->dev, sizeof(*spdif_dma->dma_desc));
			    ...
			    struct snd_pcm_substream *substream)
{
    ...
    m_dma_free_coherent(component->dev, spdif_dma->dma_desc, sizeof(*spdif_dma->dma_desc));
