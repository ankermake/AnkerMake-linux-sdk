 ...
 */
static struct jz_i2c_pin jz_i2c0_pin[1] = {
    {
        .sda        = {GPIO_PC(14),  GPIO_FUNC_3},
        .scl        = {GPIO_PC(13),  GPIO_FUNC_3},
    },
};

static struct jz_i2c_pin jz_i2c1_pin[2] = {
    {
        .sda        = {GPIO_PC(24),  GPIO_FUNC_2},
        .scl        = {GPIO_PC(23),  GPIO_FUNC_2},
    },
    {
        .sda        = {GPIO_PD(12),  GPIO_FUNC_1},
        .scl        = {GPIO_PD(11),  GPIO_FUNC_1},
    },
};

static struct jz_i2c_pin jz_i2c2_pin[3] = {
    {
        .sda        = {GPIO_PB(23),  GPIO_FUNC_2},
        .scl        = {GPIO_PB(22),  GPIO_FUNC_2},
    },
    {
        .sda        = {GPIO_PD(21),  GPIO_FUNC_2},
        .scl        = {GPIO_PD(20),  GPIO_FUNC_2},
    },
    {
        .sda        = {GPIO_PE(20),  GPIO_FUNC_1},
        .scl        = {GPIO_PE(19),  GPIO_FUNC_1},
    },
};

static struct jz_i2c_pin jz_i2c3_pin[2] = {
    {
        .sda        = {GPIO_PA(17),  GPIO_FUNC_0},
        .scl        = {GPIO_PA(16),  GPIO_FUNC_0},
    },
    {
        .sda        = {GPIO_PD(31),  GPIO_FUNC_1},
        .scl        = {GPIO_PD(30),  GPIO_FUNC_1},
    },
};

static struct jz_i2c_pin jz_i2c4_pin[2] = {
    {
        .sda        = {GPIO_PC(26),  GPIO_FUNC_1},
        .scl        = {GPIO_PC(25),  GPIO_FUNC_1},
    },
    {
        .sda        = {GPIO_PD(1),  GPIO_FUNC_2},
        .scl        = {GPIO_PD(0),  GPIO_FUNC_2},
    },
};

static struct jz_i2c_pin jz_i2c5_pin[2] = {
    {
        .sda        = {GPIO_PC(28),  GPIO_FUNC_1},
        .scl        = {GPIO_PC(27),  GPIO_FUNC_1},
    },
    {
        .sda        = {GPIO_PD(5),  GPIO_FUNC_1},
        .scl        = {GPIO_PD(4),  GPIO_FUNC_1},
    },
};
...
static struct jz_i2c_drv jz_i2c_dev[6] = {
    ...
    {
        .id         = 2,
        .irq        = (IRQ_INTC_BASE + IRQ_I2C2),
        .irq_name   = "I2C2",
        .clk_name   = "gate_i2c2",
        .scl_name   = "i2c2_scl",
        .sda_name   = "i2c2_sda",
        .alter_pin  = jz_i2c2_pin,
        .alter_num  = ARRAY_SIZE(jz_i2c2_pin),
    },
    {
        .id         = 3,
        .irq        = (IRQ_INTC_BASE + IRQ_I2C3),
        .irq_name   = "I2C3",
        .clk_name   = "gate_i2c3",
        .scl_name   = "i2c3_scl",
        .sda_name   = "i2c3_sda",
        .alter_pin  = jz_i2c3_pin,
        .alter_num  = ARRAY_SIZE(jz_i2c3_pin),
    },
    {
        .id         = 4,
        .irq        = (IRQ_INTC_BASE + IRQ_I2C4),
        .irq_name   = "I2C4",
        .clk_name   = "gate_i2c4",
        .scl_name   = "i2c4_scl",
        .sda_name   = "i2c4_sda",
        .alter_pin  = jz_i2c4_pin,
        .alter_num  = ARRAY_SIZE(jz_i2c4_pin),
    },
    {
        .id         = 5,
        .irq        = (IRQ_INTC_BASE + IRQ_I2C5),
        .irq_name   = "I2C5",
        .clk_name   = "gate_i2c5",
        .scl_name   = "i2c5_scl",
        .sda_name   = "i2c5_sda",
        .alter_pin  = jz_i2c5_pin,
        .alter_num  = ARRAY_SIZE(jz_i2c5_pin),
    },
};
...
module_param_named(i2c2_is_enable,  jz_i2c_dev[2].is_enable, int, 0644);
module_param_named(i2c2_rate,       jz_i2c_dev[2].rate, int, 0644);
module_param_gpio_named(i2c2_scl,   jz_i2c_dev[2].scl.pin, 0644);
module_param_gpio_named(i2c2_sda,   jz_i2c_dev[2].sda.pin, 0644);

module_param_named(i2c3_is_enable,  jz_i2c_dev[3].is_enable, int, 0644);
module_param_named(i2c3_rate,       jz_i2c_dev[3].rate, int, 0644);
module_param_gpio_named(i2c3_scl,   jz_i2c_dev[3].scl.pin, 0644);
module_param_gpio_named(i2c3_sda,   jz_i2c_dev[3].sda.pin, 0644);

module_param_named(i2c4_is_enable,  jz_i2c_dev[4].is_enable, int, 0644);
module_param_named(i2c4_rate,       jz_i2c_dev[4].rate, int, 0644);
module_param_gpio_named(i2c4_scl,   jz_i2c_dev[4].scl.pin, 0644);
module_param_gpio_named(i2c4_sda,   jz_i2c_dev[4].sda.pin, 0644);

module_param_named(i2c5_is_enable,  jz_i2c_dev[5].is_enable, int, 0644);
module_param_named(i2c5_rate,       jz_i2c_dev[5].rate, int, 0644);
module_param_gpio_named(i2c5_scl,   jz_i2c_dev[5].scl.pin, 0644);
module_param_gpio_named(i2c5_sda,   jz_i2c_dev[5].sda.pin, 0644);
...
static void jz_i2c_init_setting(struct jz_i2c_drv *drv)
{
    ...
    jz_i2c_write_reg(id, SMB_FLT, smb_flt_value);
...
static int jz_i2c_read(struct jz_i2c_drv *drv, int device_addr, char *buf, int len, int cmd)
{
    ...
    if ( wait_for_completion_timeout(&drv->complete, msecs_to_jiffies(timeout / 1000 + 1)) <= 0 ) {
        printk("i2c%d read timeout(%d ms)\n", id, timeout / 1000 + 1);
...
static int jz_i2c_write(struct jz_i2c_drv *drv, int device_addr, char *buf, int len, int cmd)
{
    ...
    /* 等待发送完成 */
    if ( wait_for_completion_timeout(&drv->complete, msecs_to_jiffies(timeout / 1000 + 1)) <= 0) {
        printk("i2c%d write timeout(%d ms)\n", id, timeout / 1000 + 1);
...
static int jz_i2c_init(int id)
{
    ...
    if (ret < 0) {
        printk("i2c%d modules parameter is invaild\n", id);
    ...
    if (IS_ERR(drv->clk)) {
        printk("i2c%d get clock(%s) failed\n", id, drv->clk_name);
        goto err_get_clock;
    }

    if(clk_prepare(drv->clk) < 0) {
        printk("i2c%d  prepare clock(%s) failed\n", id, drv->clk_name);
        goto err_prepare_clock;
    }

    ret = jz_i2c_gpio_request(drv);
    if (ret < 0) {
        printk("i2c%d gpio requeset failed\n", id);
    ...
    if (ret < 0) {
        printk("i2c%d Failed to request irq\n", id);
        goto err_request_irq;
    }

    ret = i2c_add_numbered_adapter(&drv->adap);
    if (ret < 0) {
        printk("i2c%d Failed to add bus\n", id);
...
static void __exit jz_arch_i2c_exit(void)
{
    ...
    if (jz_i2c_dev[2].is_finish)
        jz_i2c_deinit(2);

    if (jz_i2c_dev[3].is_finish)
        jz_i2c_deinit(3);

    if (jz_i2c_dev[4].is_finish)
        jz_i2c_deinit(4);

    if (jz_i2c_dev[5].is_finish)
        jz_i2c_deinit(5);
}
...
MODULE_DESCRIPTION("X2000 SoC I2C driver");
MODULE_LICENSE("GPL");