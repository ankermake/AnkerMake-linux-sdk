...
void tisp_g_ae_luma(tisp_core_tuning_t *core_tuning, unsigned char *luma);
...
int tisp_g_adr_strength(tisp_core_tuning_t *core_tuning, unsigned int *strength);
int tisp_s_adr_strength(tisp_core_tuning_t *core_tuning, unsigned int strength);
#endif
