...
/* kernel not support dma api */
static int spi_is_enable_dma = 0;
...
static struct jz_spi_pin jz_spi0_pin[1] = {
    {
        {
            {GPIO_PC(15), GPIO_FUNC_0, "spi0_clk"},
            {GPIO_PC(11), GPIO_FUNC_0, "spi0_miso"},
            {GPIO_PC(12), GPIO_FUNC_0, "spi0_mosi"},
        },
    },
};

static struct jz_spi_pin jz_spi1_pin[1] = {
    {
        {
            {GPIO_PC(23), GPIO_FUNC_2, "spi1_clk"},
            {GPIO_PC(20), GPIO_FUNC_2, "spi1_miso"},
            {GPIO_PC(19), GPIO_FUNC_2, "spi1_mosi"},
        },
    },
};
...
MODULE_DESCRIPTION("JZ X1830 SPI Controller Driver");
MODULE_LICENSE("GPL");
