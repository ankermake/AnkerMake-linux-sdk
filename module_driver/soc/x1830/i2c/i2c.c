...
static struct jz_i2c_pin jz_i2c0_pin[1] = {
    {
        .sda        = {GPIO_PA(12),  GPIO_FUNC_1},
        .scl        = {GPIO_PA(13),  GPIO_FUNC_1},
    },
};

static struct jz_i2c_pin jz_i2c1_pin[1] = {
    {
        .sda        = {GPIO_PB(25),  GPIO_FUNC_0},
        .scl        = {GPIO_PB(26),  GPIO_FUNC_0},
    },
};

static struct jz_i2c_pin jz_i2c2_pin[1] = {
    {
        .sda        = {GPIO_PC(27),  GPIO_FUNC_1},
        .scl        = {GPIO_PC(28),  GPIO_FUNC_1},
    },
};
...
MODULE_DESCRIPTION("X1830 SoC I2C driver");
MODULE_LICENSE("GPL");
