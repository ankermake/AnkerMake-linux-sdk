...
EXPORT_SYMBOL(ring_mem_init);
EXPORT_SYMBOL(ring_mem_readable_size);
EXPORT_SYMBOL(ring_mem_writable_size);
EXPORT_SYMBOL(ring_mem_write);
EXPORT_SYMBOL(ring_mem_read);
EXPORT_SYMBOL(ring_mem_set_virt_addr_for_write);
EXPORT_SYMBOL(ring_mem_set_virt_addr_for_read);
EXPORT_SYMBOL(ring_mem_clean);
