...
#define BOOTARGS_COMMON "console=ttyS1,115200n8 mem=25M@0x0  rmem=7M@0x1900000"
#else
...
/*#define CONFIG_SPI_QUAD*/
    ...
    #define CONFIG_BOOTARGS BOOTARGS_COMMON " init=/linuxrc rootfstype=jffs2 root=/dev/mtdblock2 rw mtdparts=jz_sfc:256k(boot),2560k(kernel),13568(root)"
...
#define CONFIG_JZ_MMC_MSC0_PB 1
    ...
    #if defined(CONFIG_SPL_SFC_NAND)
      #define CONFIG_SPL_BOOTARGS	BOOTARGS_COMMON " ip=off init=/linuxrc ubi.mtd=4 root=ubi0:rootfs ubi.mtd=5 rootfstype=ubifs ro"
...
#define CONFIG_JZ_SFC_PA
    ...
    #endif
    #define CONFIG_UBOOT_OFFSET     (27648)
