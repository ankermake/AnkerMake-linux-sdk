 ...
 */
  ...
  #define BOOTARGS_COMMON "console=ttyS1," CONFIG_BAUDRATE_STR "n8 mem=48M@0x0 rmem=16M@0x3000000"
#else
...
#define CONFIG_BOOTDELAY 1
  ...
  #define CONFIG_BOOTARGS BOOTARGS_COMMON " ip=off init=/linuxrc ubi.mtd=2 root=ubi0:rootfs rootfstype=ubifs ro ubi.mtd=3"
