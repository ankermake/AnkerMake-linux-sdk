 ...
 */
#if defined CONFIG_256MB_LPDDR
#define BOOTARGS_BASE "console=ttyS2,115200n8 consoleblank=0 mem=256M lpj=5009408 "
#elif defined CONFIG_64MB_LPDDR
...
/* uboot load kernel settings. */
	...
	#ifdef CONFIG_AVS_DEV
		#define	CONFIG_BOOTARGS BOOTARGS_COMMON "ip=off init=/linuxrc ubi.mtd=2 root=ubi0:rootfs ubi.mtd=3 rootfstype=ubifs ro"
...
/* spl load kernel settings. */
	...
	#define CONFIG_SPL_OTA_OS_NAME        "ota_kernel"
