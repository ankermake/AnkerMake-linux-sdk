...
#if defined(CONFIG_SYS_UART2_PC13_PC14)
	[2] = { .port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins = 0x3 << 13},
#elif defined(CONFIG_SYS_UART2_PC8_PC9)
	[2] = { .port = GPIO_PORT_C, .func = GPIO_FUNC_2, .pins = 0x3 << 8},
#endif
};
...
static struct jz_gpio_func_def gpio_func[] = {
	...
	{ .port = GPIO_PORT_A, .func = GPIO_FUNC_1, .pins = (0x3b << 23)},
	{ .port = GPIO_PORT_A, .func = GPIO_FUNC_1 | GPIO_PULLUP, .pins = (0x01 << 25)},
#endif
};
#endif
